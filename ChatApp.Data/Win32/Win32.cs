...
namespace ChatApp.Win
{
    internal class Win32
    {
        ...
        public const int WmNclbuttondown = 161;

        public const int HtCaption = 2;

        public const int SmtoAbortifhung = 2;

        public static Guid iidIhtmlDocument = new Guid("626FC520-A41E-11CF-A731-00A0C9082637");
        ...
        {
            var expr13 = GCHandle.FromIntPtr(pointer).Target as List<IntPtr>;
            if (expr13 == null)
