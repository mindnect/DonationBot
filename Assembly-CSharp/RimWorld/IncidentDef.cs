...
namespace RimWorld
{
	public class IncidentDef : Def
	{
		...
		{
			IncidentDef.<ConfigErrors>c__Iterator8A <ConfigErrors>c__Iterator8A = new IncidentDef.<ConfigErrors>c__Iterator8A();
			<ConfigErrors>c__Iterator8A.<>f__this = this;
			IncidentDef.<ConfigErrors>c__Iterator8A expr_0E = <ConfigErrors>c__Iterator8A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
