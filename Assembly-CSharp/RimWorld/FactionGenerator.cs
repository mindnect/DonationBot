...
namespace RimWorld
{
	public static class FactionGenerator
	{
		...
		private static readonly FloatRange FactionBasesPer100kTiles = new FloatRange(60f, 70f);
		...
		{
			FactionGenerator.<EnsureRequiredEnemies>c__AnonStorey309 <EnsureRequiredEnemies>c__AnonStorey = new FactionGenerator.<EnsureRequiredEnemies>c__AnonStorey309();
