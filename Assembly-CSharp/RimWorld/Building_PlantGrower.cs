...
namespace RimWorld
{
	public class Building_PlantGrower : Building, IPlantToGrowSettable
	{
		...
		public IEnumerable<Plant> PlantsOnMe
		{
			get
			{
				Building_PlantGrower.<>c__Iterator141 <>c__Iterator = new Building_PlantGrower.<>c__Iterator141();
				<>c__Iterator.<>f__this = this;
				Building_PlantGrower.<>c__Iterator141 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Building_PlantGrower.<GetGizmos>c__Iterator142 <GetGizmos>c__Iterator = new Building_PlantGrower.<GetGizmos>c__Iterator142();
			<GetGizmos>c__Iterator.<>f__this = this;
			Building_PlantGrower.<GetGizmos>c__Iterator142 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
