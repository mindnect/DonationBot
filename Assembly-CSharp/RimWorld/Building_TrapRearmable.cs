...
namespace RimWorld
{
	public class Building_TrapRearmable : Building_Trap
	{
		...
		{
			Building_TrapRearmable.<GetGizmos>c__Iterator12C <GetGizmos>c__Iterator12C = new Building_TrapRearmable.<GetGizmos>c__Iterator12C();
			<GetGizmos>c__Iterator12C.<>f__this = this;
			Building_TrapRearmable.<GetGizmos>c__Iterator12C expr_0E = <GetGizmos>c__Iterator12C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
