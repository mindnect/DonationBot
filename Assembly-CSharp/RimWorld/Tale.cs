...
namespace RimWorld
{
	public class Tale : ILoadReferenceable, IExposable
	{
		...
		{
			Tale.<GetTextGenerationRules>c__Iterator115 <GetTextGenerationRules>c__Iterator = new Tale.<GetTextGenerationRules>c__Iterator115();
			<GetTextGenerationRules>c__Iterator.<>f__this = this;
			Tale.<GetTextGenerationRules>c__Iterator115 expr_0E = <GetTextGenerationRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			Tale.<SpecialTextGenerationRules>c__Iterator116 <SpecialTextGenerationRules>c__Iterator = new Tale.<SpecialTextGenerationRules>c__Iterator116();
			Tale.<SpecialTextGenerationRules>c__Iterator116 expr_07 = <SpecialTextGenerationRules>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
