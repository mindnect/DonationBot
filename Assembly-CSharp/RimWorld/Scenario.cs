...
namespace RimWorld
{
	public class Scenario : IExposable, WorkshopUploadable
	{
		...
		public IEnumerable<ScenPart> AllParts
		{
			get
			{
				Scenario.<>c__Iterator10A <>c__Iterator10A = new Scenario.<>c__Iterator10A();
				<>c__Iterator10A.<>f__this = this;
				Scenario.<>c__Iterator10A expr_0E = <>c__Iterator10A;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Scenario.<ConfigErrors>c__Iterator10B <ConfigErrors>c__Iterator10B = new Scenario.<ConfigErrors>c__Iterator10B();
			<ConfigErrors>c__Iterator10B.<>f__this = this;
			Scenario.<ConfigErrors>c__Iterator10B expr_0E = <ConfigErrors>c__Iterator10B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
