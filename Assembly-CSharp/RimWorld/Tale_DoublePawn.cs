...
namespace RimWorld
{
	public class Tale_DoublePawn : Tale
	{
		...
		{
			Tale_DoublePawn.<SpecialTextGenerationRules>c__Iterator117 <SpecialTextGenerationRules>c__Iterator = new Tale_DoublePawn.<SpecialTextGenerationRules>c__Iterator117();
			<SpecialTextGenerationRules>c__Iterator.<>f__this = this;
			Tale_DoublePawn.<SpecialTextGenerationRules>c__Iterator117 expr_0E = <SpecialTextGenerationRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
