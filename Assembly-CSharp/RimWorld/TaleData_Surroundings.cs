...
namespace RimWorld
{
	public class TaleData_Surroundings : TaleData
	{
		...
		{
			TaleData_Surroundings.<GetRules>c__Iterator112 <GetRules>c__Iterator = new TaleData_Surroundings.<GetRules>c__Iterator112();
			<GetRules>c__Iterator.<>f__this = this;
			TaleData_Surroundings.<GetRules>c__Iterator112 expr_0E = <GetRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
