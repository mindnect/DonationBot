...
namespace RimWorld
{
	public class JobDriver_ManTurret : JobDriver
	{
		...
		{
			JobDriver_ManTurret.<MakeNewToils>c__Iterator33 <MakeNewToils>c__Iterator = new JobDriver_ManTurret.<MakeNewToils>c__Iterator33();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_ManTurret.<MakeNewToils>c__Iterator33 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
