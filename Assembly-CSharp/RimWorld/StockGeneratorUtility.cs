...
namespace RimWorld
{
	public class StockGeneratorUtility
	{
		...
		{
			StockGeneratorUtility.<TryMakeForStock>c__Iterator159 <TryMakeForStock>c__Iterator = new StockGeneratorUtility.<TryMakeForStock>c__Iterator159();
			<TryMakeForStock>c__Iterator.thingDef = thingDef;
			<TryMakeForStock>c__Iterator.count = count;
			<TryMakeForStock>c__Iterator.<$>thingDef = thingDef;
			<TryMakeForStock>c__Iterator.<$>count = count;
			StockGeneratorUtility.<TryMakeForStock>c__Iterator159 expr_23 = <TryMakeForStock>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
