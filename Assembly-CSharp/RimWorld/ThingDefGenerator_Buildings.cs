...
namespace RimWorld
{
	public static class ThingDefGenerator_Buildings
	{
		...
		{
			ThingDefGenerator_Buildings.<ImpliedBlueprintAndFrameDefs>c__Iterator6F <ImpliedBlueprintAndFrameDefs>c__Iterator6F = new ThingDefGenerator_Buildings.<ImpliedBlueprintAndFrameDefs>c__Iterator6F();
			ThingDefGenerator_Buildings.<ImpliedBlueprintAndFrameDefs>c__Iterator6F expr_07 = <ImpliedBlueprintAndFrameDefs>c__Iterator6F;
			expr_07.$PC = -2;
			return expr_07;
		}
