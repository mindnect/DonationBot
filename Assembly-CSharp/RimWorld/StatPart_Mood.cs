...
namespace RimWorld
{
	public class StatPart_Mood : StatPart
	{
		...
		{
			StatPart_Mood.<ConfigErrors>c__Iterator18C <ConfigErrors>c__Iterator18C = new StatPart_Mood.<ConfigErrors>c__Iterator18C();
			<ConfigErrors>c__Iterator18C.<>f__this = this;
			StatPart_Mood.<ConfigErrors>c__Iterator18C expr_0E = <ConfigErrors>c__Iterator18C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
