...
namespace RimWorld
{
	public class Storyteller : IExposable
	{
		...
		{
			Storyteller.<MakeIncidentsForInterval>c__Iterator9D <MakeIncidentsForInterval>c__Iterator9D = new Storyteller.<MakeIncidentsForInterval>c__Iterator9D();
			<MakeIncidentsForInterval>c__Iterator9D.<>f__this = this;
			Storyteller.<MakeIncidentsForInterval>c__Iterator9D expr_0E = <MakeIncidentsForInterval>c__Iterator9D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
