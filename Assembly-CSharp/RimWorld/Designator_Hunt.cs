...
namespace RimWorld
{
	public class Designator_Hunt : Designator
	{
		...
		{
			Designator_Hunt.<HuntablesInCell>c__Iterator171 <HuntablesInCell>c__Iterator = new Designator_Hunt.<HuntablesInCell>c__Iterator171();
			<HuntablesInCell>c__Iterator.c = c;
			<HuntablesInCell>c__Iterator.<$>c = c;
			<HuntablesInCell>c__Iterator.<>f__this = this;
			Designator_Hunt.<HuntablesInCell>c__Iterator171 expr_1C = <HuntablesInCell>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
