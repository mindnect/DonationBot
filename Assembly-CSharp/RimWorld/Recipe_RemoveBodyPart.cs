...
namespace RimWorld
{
	internal class Recipe_RemoveBodyPart : Recipe_Surgery
	{
		...
		{
			Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorBB <GetPartsToApplyOn>c__IteratorBB = new Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorBB();
			<GetPartsToApplyOn>c__IteratorBB.pawn = pawn;
			<GetPartsToApplyOn>c__IteratorBB.<$>pawn = pawn;
			Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorBB expr_15 = <GetPartsToApplyOn>c__IteratorBB;
			expr_15.$PC = -2;
			return expr_15;
		}
