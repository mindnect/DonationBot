...
namespace RimWorld
{
	...
	public class Building_FermentingBarrel : Building
	{
		...
		{
			Building_FermentingBarrel.<GetGizmos>c__Iterator13C <GetGizmos>c__Iterator13C = new Building_FermentingBarrel.<GetGizmos>c__Iterator13C();
			<GetGizmos>c__Iterator13C.<>f__this = this;
			Building_FermentingBarrel.<GetGizmos>c__Iterator13C expr_0E = <GetGizmos>c__Iterator13C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
