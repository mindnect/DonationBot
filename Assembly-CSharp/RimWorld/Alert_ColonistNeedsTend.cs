...
namespace RimWorld
{
	public class Alert_ColonistNeedsTend : Alert
	{
		private IEnumerable<Pawn> NeedingColonists
		{
			get
			{
				Alert_ColonistNeedsTend.<>c__Iterator16B <>c__Iterator16B = new Alert_ColonistNeedsTend.<>c__Iterator16B();
				Alert_ColonistNeedsTend.<>c__Iterator16B expr_07 = <>c__Iterator16B;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
