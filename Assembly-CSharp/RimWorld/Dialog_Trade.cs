...
namespace RimWorld
{
	public class Dialog_Trade : Window
	{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			{
				Text.Font = GameFont.Small;
				float usedMass = CollectionsMassCalculator.MassUsageLeftAfterTradeableTransfer(this.playerCaravanAllPawnsAndItems, this.cachedTradeables, true, false, false);
				float availableMass = CollectionsMassCalculator.CapacityLeftAfterTradeableTransfer(this.playerCaravanAllPawnsAndItems, this.cachedTradeables);
				Rect rect6 = rect.AtZero();
				rect6.y = 27f;
				TransferableUIUtility.DrawMassInfo(rect6, usedMass, availableMass, "TradeMassUsageTooltip".Translate(), -9999f, false);
				CaravanUIUtility.DrawDaysWorthOfFoodInfo(new Rect(rect6.x, rect6.y + 22f, rect6.width, rect6.height), DaysWorthOfFoodCalculator.ApproxDaysWorthOfFoodLeftAfterTradeableTransfer(this.playerCaravanAllPawnsAndItems, this.cachedTradeables), false);
			}
			GUI.EndGroup();
			float num2 = 0f;
