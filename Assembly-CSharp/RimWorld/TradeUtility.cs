...
namespace RimWorld
{
	public static class TradeUtility
	{
		...
		{
			TradeUtility.<AllLaunchableThings>c__Iterator165 <AllLaunchableThings>c__Iterator = new TradeUtility.<AllLaunchableThings>c__Iterator165();
			<AllLaunchableThings>c__Iterator.map = map;
			<AllLaunchableThings>c__Iterator.<$>map = map;
			TradeUtility.<AllLaunchableThings>c__Iterator165 expr_15 = <AllLaunchableThings>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			TradeUtility.<AllSellableColonyPawns>c__Iterator166 <AllSellableColonyPawns>c__Iterator = new TradeUtility.<AllSellableColonyPawns>c__Iterator166();
			<AllSellableColonyPawns>c__Iterator.map = map;
			<AllSellableColonyPawns>c__Iterator.<$>map = map;
			TradeUtility.<AllSellableColonyPawns>c__Iterator166 expr_15 = <AllSellableColonyPawns>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
