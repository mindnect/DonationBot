...
namespace RimWorld
{
	public class CompUsable : ThingComp
	{
		...
		{
			CompUsable.<CompFloatMenuOptions>c__Iterator14D <CompFloatMenuOptions>c__Iterator14D = new CompUsable.<CompFloatMenuOptions>c__Iterator14D();
			<CompFloatMenuOptions>c__Iterator14D.myPawn = myPawn;
			<CompFloatMenuOptions>c__Iterator14D.<$>myPawn = myPawn;
			<CompFloatMenuOptions>c__Iterator14D.<>f__this = this;
			CompUsable.<CompFloatMenuOptions>c__Iterator14D expr_1C = <CompFloatMenuOptions>c__Iterator14D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
