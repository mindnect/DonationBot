...
namespace RimWorld
{
	public class ScenPart_DisallowBuilding : ScenPart_Rule
	{
		...
		{
			ScenPart_DisallowBuilding.<GetSummaryListEntries>c__IteratorFC <GetSummaryListEntries>c__IteratorFC = new ScenPart_DisallowBuilding.<GetSummaryListEntries>c__IteratorFC();
			<GetSummaryListEntries>c__IteratorFC.tag = tag;
			<GetSummaryListEntries>c__IteratorFC.<$>tag = tag;
			<GetSummaryListEntries>c__IteratorFC.<>f__this = this;
			ScenPart_DisallowBuilding.<GetSummaryListEntries>c__IteratorFC expr_1C = <GetSummaryListEntries>c__IteratorFC;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			ScenPart_DisallowBuilding.<RandomizableBuildingDefs>c__IteratorFD <RandomizableBuildingDefs>c__IteratorFD = new ScenPart_DisallowBuilding.<RandomizableBuildingDefs>c__IteratorFD();
			ScenPart_DisallowBuilding.<RandomizableBuildingDefs>c__IteratorFD expr_07 = <RandomizableBuildingDefs>c__IteratorFD;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
