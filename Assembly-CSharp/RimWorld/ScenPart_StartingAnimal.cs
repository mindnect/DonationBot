...
namespace RimWorld
{
	public class ScenPart_StartingAnimal : ScenPart
	{
		...
		{
			ScenPart_StartingAnimal.<GetSummaryListEntries>c__Iterator102 <GetSummaryListEntries>c__Iterator = new ScenPart_StartingAnimal.<GetSummaryListEntries>c__Iterator102();
			<GetSummaryListEntries>c__Iterator.tag = tag;
			<GetSummaryListEntries>c__Iterator.<$>tag = tag;
			<GetSummaryListEntries>c__Iterator.<>f__this = this;
			ScenPart_StartingAnimal.<GetSummaryListEntries>c__Iterator102 expr_1C = <GetSummaryListEntries>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			ScenPart_StartingAnimal.<PlayerStartingThings>c__Iterator103 <PlayerStartingThings>c__Iterator = new ScenPart_StartingAnimal.<PlayerStartingThings>c__Iterator103();
			<PlayerStartingThings>c__Iterator.<>f__this = this;
			ScenPart_StartingAnimal.<PlayerStartingThings>c__Iterator103 expr_0E = <PlayerStartingThings>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
