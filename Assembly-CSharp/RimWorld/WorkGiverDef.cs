...
namespace RimWorld
{
	public class WorkGiverDef : Def
	{
		...
		{
			WorkGiverDef.<ConfigErrors>c__Iterator1C5 <ConfigErrors>c__Iterator1C = new WorkGiverDef.<ConfigErrors>c__Iterator1C5();
			<ConfigErrors>c__Iterator1C.<>f__this = this;
			WorkGiverDef.<ConfigErrors>c__Iterator1C5 expr_0E = <ConfigErrors>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
