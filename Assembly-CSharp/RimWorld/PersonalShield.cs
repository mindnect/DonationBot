...
namespace RimWorld
{
	...
	public class PersonalShield : Apparel
	{
		...
		{
			PersonalShield.<GetWornGizmos>c__Iterator146 <GetWornGizmos>c__Iterator = new PersonalShield.<GetWornGizmos>c__Iterator146();
			<GetWornGizmos>c__Iterator.<>f__this = this;
			PersonalShield.<GetWornGizmos>c__Iterator146 expr_0E = <GetWornGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
