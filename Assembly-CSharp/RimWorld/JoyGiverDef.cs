...
namespace RimWorld
{
	public class JoyGiverDef : Def
	{
		...
		{
			JoyGiverDef.<ConfigErrors>c__Iterator8B <ConfigErrors>c__Iterator8B = new JoyGiverDef.<ConfigErrors>c__Iterator8B();
			<ConfigErrors>c__Iterator8B.<>f__this = this;
			JoyGiverDef.<ConfigErrors>c__Iterator8B expr_0E = <ConfigErrors>c__Iterator8B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
