...
namespace RimWorld
{
	public class CompSpawnerHives : ThingComp
	{
		...
		{
			CompSpawnerHives.<CompGetGizmosExtra>c__Iterator150 <CompGetGizmosExtra>c__Iterator = new CompSpawnerHives.<CompGetGizmosExtra>c__Iterator150();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompSpawnerHives.<CompGetGizmosExtra>c__Iterator150 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
