...
namespace RimWorld
{
	public class Selector
	{
		...
		{
			Selector.<SelectableObjectsUnderMouse>c__Iterator180 <SelectableObjectsUnderMouse>c__Iterator = new Selector.<SelectableObjectsUnderMouse>c__Iterator180();
			Selector.<SelectableObjectsUnderMouse>c__Iterator180 expr_07 = <SelectableObjectsUnderMouse>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			Selector.<SelectableObjectsAt>c__Iterator181 <SelectableObjectsAt>c__Iterator = new Selector.<SelectableObjectsAt>c__Iterator181();
			<SelectableObjectsAt>c__Iterator.c = c;
			<SelectableObjectsAt>c__Iterator.map = map;
			<SelectableObjectsAt>c__Iterator.<$>c = c;
			<SelectableObjectsAt>c__Iterator.<$>map = map;
			Selector.<SelectableObjectsAt>c__Iterator181 expr_23 = <SelectableObjectsAt>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
