...
namespace RimWorld
{
	public static class GenStuff
	{
		...
		{
			GenStuff.<AllowedStuffsFor>c__Iterator188 <AllowedStuffsFor>c__Iterator = new GenStuff.<AllowedStuffsFor>c__Iterator188();
			<AllowedStuffsFor>c__Iterator.td = td;
			<AllowedStuffsFor>c__Iterator.<$>td = td;
			GenStuff.<AllowedStuffsFor>c__Iterator188 expr_15 = <AllowedStuffsFor>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
