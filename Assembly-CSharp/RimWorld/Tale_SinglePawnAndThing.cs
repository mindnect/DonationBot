...
namespace RimWorld
{
	public class Tale_SinglePawnAndThing : Tale_SinglePawn
	{
		...
		{
			Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11C <SpecialTextGenerationRules>c__Iterator11C = new Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11C();
			<SpecialTextGenerationRules>c__Iterator11C.<>f__this = this;
			Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11C expr_0E = <SpecialTextGenerationRules>c__Iterator11C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
