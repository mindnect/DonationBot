...
namespace RimWorld
{
	public abstract class CompTerrainPump : ThingComp
	{
		...
		{
			CompTerrainPump.<CompGetGizmosExtra>c__Iterator152 <CompGetGizmosExtra>c__Iterator = new CompTerrainPump.<CompGetGizmosExtra>c__Iterator152();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompTerrainPump.<CompGetGizmosExtra>c__Iterator152 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
