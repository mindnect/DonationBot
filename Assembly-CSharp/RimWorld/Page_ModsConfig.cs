...
namespace RimWorld
{
	public class Page_ModsConfig : Page
	{
		...
		{
			Page_ModsConfig.<ModsInListOrder>c__Iterator17C <ModsInListOrder>c__Iterator17C = new Page_ModsConfig.<ModsInListOrder>c__Iterator17C();
			Page_ModsConfig.<ModsInListOrder>c__Iterator17C expr_07 = <ModsInListOrder>c__Iterator17C;
			expr_07.$PC = -2;
			return expr_07;
		}
