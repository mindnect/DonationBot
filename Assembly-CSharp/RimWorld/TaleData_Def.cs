...
namespace RimWorld
{
	public class TaleData_Def : TaleData
	{
		...
		{
			TaleData_Def.<GetRules>c__Iterator111 <GetRules>c__Iterator = new TaleData_Def.<GetRules>c__Iterator111();
			<GetRules>c__Iterator.prefix = prefix;
			<GetRules>c__Iterator.<$>prefix = prefix;
			<GetRules>c__Iterator.<>f__this = this;
			TaleData_Def.<GetRules>c__Iterator111 expr_1C = <GetRules>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
