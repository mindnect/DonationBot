...
namespace RimWorld
{
	internal class Building_SunLamp : Building
	{
		...
		{
			Building_SunLamp.<GetGizmos>c__Iterator143 <GetGizmos>c__Iterator = new Building_SunLamp.<GetGizmos>c__Iterator143();
			<GetGizmos>c__Iterator.<>f__this = this;
			Building_SunLamp.<GetGizmos>c__Iterator143 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
