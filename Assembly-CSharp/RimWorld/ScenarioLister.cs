...
namespace RimWorld
{
	public static class ScenarioLister
	{
		...
		{
			ScenarioLister.<AllScenarios>c__Iterator10C <AllScenarios>c__Iterator10C = new ScenarioLister.<AllScenarios>c__Iterator10C();
			ScenarioLister.<AllScenarios>c__Iterator10C expr_07 = <AllScenarios>c__Iterator10C;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			ScenarioLister.<ScenariosInCategory>c__Iterator10D <ScenariosInCategory>c__Iterator10D = new ScenarioLister.<ScenariosInCategory>c__Iterator10D();
			<ScenariosInCategory>c__Iterator10D.cat = cat;
			<ScenariosInCategory>c__Iterator10D.<$>cat = cat;
			ScenarioLister.<ScenariosInCategory>c__Iterator10D expr_15 = <ScenariosInCategory>c__Iterator10D;
			expr_15.$PC = -2;
			return expr_15;
		}
