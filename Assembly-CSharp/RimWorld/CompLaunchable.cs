...
namespace RimWorld
{
	...
	public class CompLaunchable : ThingComp
	{
		...
		{
			CompLaunchable.<CompGetGizmosExtra>c__Iterator14B <CompGetGizmosExtra>c__Iterator14B = new CompLaunchable.<CompGetGizmosExtra>c__Iterator14B();
			<CompGetGizmosExtra>c__Iterator14B.<>f__this = this;
			CompLaunchable.<CompGetGizmosExtra>c__Iterator14B expr_0E = <CompGetGizmosExtra>c__Iterator14B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
