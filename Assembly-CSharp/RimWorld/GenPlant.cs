...
namespace RimWorld
{
	public static class GenPlant
	{
		...
		{
			GenPlant.<ValidPlantTypesForGrowers>c__Iterator187 <ValidPlantTypesForGrowers>c__Iterator = new GenPlant.<ValidPlantTypesForGrowers>c__Iterator187();
			<ValidPlantTypesForGrowers>c__Iterator.sel = sel;
			<ValidPlantTypesForGrowers>c__Iterator.<$>sel = sel;
			GenPlant.<ValidPlantTypesForGrowers>c__Iterator187 expr_15 = <ValidPlantTypesForGrowers>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
