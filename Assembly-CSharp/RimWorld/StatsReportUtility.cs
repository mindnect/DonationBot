...
namespace RimWorld
{
	public static class StatsReportUtility
	{
		...
		{
			StatsReportUtility.<StatsToDraw>c__Iterator17A <StatsToDraw>c__Iterator17A = new StatsReportUtility.<StatsToDraw>c__Iterator17A();
			<StatsToDraw>c__Iterator17A.def = def;
			<StatsToDraw>c__Iterator17A.stuff = stuff;
			<StatsToDraw>c__Iterator17A.<$>def = def;
			<StatsToDraw>c__Iterator17A.<$>stuff = stuff;
			StatsReportUtility.<StatsToDraw>c__Iterator17A expr_23 = <StatsToDraw>c__Iterator17A;
			expr_23.$PC = -2;
			return expr_23;
		}
		...
		{
			StatsReportUtility.<StatsToDraw>c__Iterator17B <StatsToDraw>c__Iterator17B = new StatsReportUtility.<StatsToDraw>c__Iterator17B();
			<StatsToDraw>c__Iterator17B.thing = thing;
			<StatsToDraw>c__Iterator17B.<$>thing = thing;
			StatsReportUtility.<StatsToDraw>c__Iterator17B expr_15 = <StatsToDraw>c__Iterator17B;
			expr_15.$PC = -2;
			return expr_15;
		}
