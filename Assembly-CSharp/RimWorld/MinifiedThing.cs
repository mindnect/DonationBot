...
namespace RimWorld
{
	public class MinifiedThing : ThingWithComps, IThingContainerOwner
	{
		...
		{
			MinifiedThing.<GetGizmos>c__Iterator127 <GetGizmos>c__Iterator = new MinifiedThing.<GetGizmos>c__Iterator127();
			<GetGizmos>c__Iterator.<>f__this = this;
			MinifiedThing.<GetGizmos>c__Iterator127 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
