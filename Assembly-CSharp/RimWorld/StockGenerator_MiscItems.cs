...
namespace RimWorld
{
	public abstract class StockGenerator_MiscItems : StockGenerator
	{
		...
		{
			StockGenerator_MiscItems.<GenerateThings>c__Iterator162 <GenerateThings>c__Iterator = new StockGenerator_MiscItems.<GenerateThings>c__Iterator162();
			<GenerateThings>c__Iterator.<>f__this = this;
			StockGenerator_MiscItems.<GenerateThings>c__Iterator162 expr_0E = <GenerateThings>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
