...
namespace RimWorld
{
	public class ScenPart_PlayerFaction : ScenPart
	{
		...
		{
			ScenPart_PlayerFaction.<ConfigErrors>c__Iterator101 <ConfigErrors>c__Iterator = new ScenPart_PlayerFaction.<ConfigErrors>c__Iterator101();
			<ConfigErrors>c__Iterator.<>f__this = this;
			ScenPart_PlayerFaction.<ConfigErrors>c__Iterator101 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
