...
namespace RimWorld
{
	public class WorkGiver_PlantsCut : WorkGiver_Scanner
	{
		...
		{
			WorkGiver_PlantsCut.<PotentialWorkThingsGlobal>c__Iterator62 <PotentialWorkThingsGlobal>c__Iterator = new WorkGiver_PlantsCut.<PotentialWorkThingsGlobal>c__Iterator62();
			<PotentialWorkThingsGlobal>c__Iterator.pawn = pawn;
			<PotentialWorkThingsGlobal>c__Iterator.<$>pawn = pawn;
			WorkGiver_PlantsCut.<PotentialWorkThingsGlobal>c__Iterator62 expr_15 = <PotentialWorkThingsGlobal>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
