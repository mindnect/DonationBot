...
namespace RimWorld
{
	public class JobDriver_FoodDeliver : JobDriver
	{
		...
		{
			JobDriver_FoodDeliver.<MakeNewToils>c__Iterator4A <MakeNewToils>c__Iterator4A = new JobDriver_FoodDeliver.<MakeNewToils>c__Iterator4A();
			<MakeNewToils>c__Iterator4A.<>f__this = this;
			JobDriver_FoodDeliver.<MakeNewToils>c__Iterator4A expr_0E = <MakeNewToils>c__Iterator4A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
