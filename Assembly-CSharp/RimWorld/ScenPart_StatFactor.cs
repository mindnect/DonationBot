...
namespace RimWorld
{
	public class ScenPart_StatFactor : ScenPart
	{
		...
		{
			ScenPart_StatFactor.<RandomizableStats>c__Iterator104 <RandomizableStats>c__Iterator = new ScenPart_StatFactor.<RandomizableStats>c__Iterator104();
			ScenPart_StatFactor.<RandomizableStats>c__Iterator104 expr_07 = <RandomizableStats>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
