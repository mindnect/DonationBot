...
namespace RimWorld
{
	public static class FactionDialogMaker
	{
		...
		{
			FactionDialogMaker.<DebugOptions>c__IteratorE8 <DebugOptions>c__IteratorE = new FactionDialogMaker.<DebugOptions>c__IteratorE8();
			FactionDialogMaker.<DebugOptions>c__IteratorE8 expr_07 = <DebugOptions>c__IteratorE;
			expr_07.$PC = -2;
			return expr_07;
		}
