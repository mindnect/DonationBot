...
namespace RimWorld
{
	...
	public abstract class Alert
	{
		...
		{
			Alert.<DrawInfoPane>c__AnonStorey363 <DrawInfoPane>c__AnonStorey = new Alert.<DrawInfoPane>c__AnonStorey363();
			Text.Font = GameFont.Small;
			Text.Anchor = TextAnchor.UpperLeft;
			...
			{
				Alert.<DrawInfoPane>c__AnonStorey363 expr_E2_cp_0 = <DrawInfoPane>c__AnonStorey;
