...
namespace RimWorld
{
	public class TaleData_Trader : TaleData
	{
		...
		{
			TaleData_Trader.<GetRules>c__Iterator114 <GetRules>c__Iterator = new TaleData_Trader.<GetRules>c__Iterator114();
			<GetRules>c__Iterator.prefix = prefix;
			<GetRules>c__Iterator.<$>prefix = prefix;
			<GetRules>c__Iterator.<>f__this = this;
			TaleData_Trader.<GetRules>c__Iterator114 expr_1C = <GetRules>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
