...
namespace RimWorld
{
	public class PawnRelationDef : Def
	{
		...
		{
			PawnRelationDef.<ConfigErrors>c__Iterator8D <ConfigErrors>c__Iterator8D = new PawnRelationDef.<ConfigErrors>c__Iterator8D();
			<ConfigErrors>c__Iterator8D.<>f__this = this;
			PawnRelationDef.<ConfigErrors>c__Iterator8D expr_0E = <ConfigErrors>c__Iterator8D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
