...
namespace RimWorld
{
	public class IncidentWorker_ShipChunkDrop : IncidentWorker
	{
		...
		{
			IncidentWorker_ShipChunkDrop.<SpawnChunk>c__AnonStorey2A4 <SpawnChunk>c__AnonStorey2A = new IncidentWorker_ShipChunkDrop.<SpawnChunk>c__AnonStorey2A4();
			<SpawnChunk>c__AnonStorey2A.map = map;
			<SpawnChunk>c__AnonStorey2A.cr = CellRect.SingleCell(pos);
			IncidentWorker_ShipChunkDrop.<SpawnChunk>c__AnonStorey2A4 expr_1F_cp_0 = <SpawnChunk>c__AnonStorey2A;
			expr_1F_cp_0.cr.Width = expr_1F_cp_0.cr.Width + 1;
			IncidentWorker_ShipChunkDrop.<SpawnChunk>c__AnonStorey2A4 expr_32_cp_0 = <SpawnChunk>c__AnonStorey2A;
