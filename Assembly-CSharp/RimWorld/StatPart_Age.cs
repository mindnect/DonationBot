...
namespace RimWorld
{
	public class StatPart_Age : StatPart
	{
		...
		{
			StatPart_Age.<ConfigErrors>c__Iterator18B <ConfigErrors>c__Iterator18B = new StatPart_Age.<ConfigErrors>c__Iterator18B();
			<ConfigErrors>c__Iterator18B.<>f__this = this;
			StatPart_Age.<ConfigErrors>c__Iterator18B expr_0E = <ConfigErrors>c__Iterator18B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
