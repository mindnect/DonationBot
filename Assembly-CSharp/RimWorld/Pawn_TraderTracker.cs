...
namespace RimWorld
{
	public class Pawn_TraderTracker : IExposable
	{
		...
		public IEnumerable<Thing> Goods
		{
			get
			{
				Pawn_TraderTracker.<>c__IteratorDF <>c__IteratorDF = new Pawn_TraderTracker.<>c__IteratorDF();
				<>c__IteratorDF.<>f__this = this;
				Pawn_TraderTracker.<>c__IteratorDF expr_0E = <>c__IteratorDF;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Pawn_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorE0 <ColonyThingsWillingToBuy>c__IteratorE = new Pawn_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorE0();
			<ColonyThingsWillingToBuy>c__IteratorE.<>f__this = this;
			Pawn_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorE0 expr_0E = <ColonyThingsWillingToBuy>c__IteratorE;
			expr_0E.$PC = -2;
			return expr_0E;
		}
