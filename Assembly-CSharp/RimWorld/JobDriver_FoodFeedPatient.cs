...
namespace RimWorld
{
	public class JobDriver_FoodFeedPatient : JobDriver
	{
		...
		{
			JobDriver_FoodFeedPatient.<MakeNewToils>c__Iterator4B <MakeNewToils>c__Iterator4B = new JobDriver_FoodFeedPatient.<MakeNewToils>c__Iterator4B();
			<MakeNewToils>c__Iterator4B.<>f__this = this;
			JobDriver_FoodFeedPatient.<MakeNewToils>c__Iterator4B expr_0E = <MakeNewToils>c__Iterator4B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
