...
namespace RimWorld
{
	public abstract class JobDriver_PlantWork : JobDriver
	{
		...
		{
			JobDriver_PlantWork.<MakeNewToils>c__Iterator45 <MakeNewToils>c__Iterator = new JobDriver_PlantWork.<MakeNewToils>c__Iterator45();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_PlantWork.<MakeNewToils>c__Iterator45 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
