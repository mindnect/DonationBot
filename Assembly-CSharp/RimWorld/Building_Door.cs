...
namespace RimWorld
{
	public class Building_Door : Building
	{
		...
		{
			Building_Door.<GetGizmos>c__Iterator13B <GetGizmos>c__Iterator13B = new Building_Door.<GetGizmos>c__Iterator13B();
			<GetGizmos>c__Iterator13B.<>f__this = this;
			Building_Door.<GetGizmos>c__Iterator13B expr_0E = <GetGizmos>c__Iterator13B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
