...
namespace RimWorld
{
	public class ScenPart_OnPawnDeathExplode : ScenPart
	{
		...
		{
			ScenPart_OnPawnDeathExplode.<PossibleDamageDefs>c__IteratorFB <PossibleDamageDefs>c__IteratorFB = new ScenPart_OnPawnDeathExplode.<PossibleDamageDefs>c__IteratorFB();
			ScenPart_OnPawnDeathExplode.<PossibleDamageDefs>c__IteratorFB expr_07 = <PossibleDamageDefs>c__IteratorFB;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
