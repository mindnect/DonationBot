...
namespace RimWorld
{
	public class JobDriver_FleeAndCower : JobDriver
	{
		...
		{
			JobDriver_FleeAndCower.<MakeNewToils>c__Iterator2B <MakeNewToils>c__Iterator2B = new JobDriver_FleeAndCower.<MakeNewToils>c__Iterator2B();
			<MakeNewToils>c__Iterator2B.<>f__this = this;
			JobDriver_FleeAndCower.<MakeNewToils>c__Iterator2B expr_0E = <MakeNewToils>c__Iterator2B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
