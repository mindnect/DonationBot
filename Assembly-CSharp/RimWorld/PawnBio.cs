...
namespace RimWorld
{
	public class PawnBio
	{
		...
		{
			PawnBio.<ConfigErrors>c__IteratorDA <ConfigErrors>c__IteratorDA = new PawnBio.<ConfigErrors>c__IteratorDA();
			<ConfigErrors>c__IteratorDA.<>f__this = this;
			PawnBio.<ConfigErrors>c__IteratorDA expr_0E = <ConfigErrors>c__IteratorDA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
