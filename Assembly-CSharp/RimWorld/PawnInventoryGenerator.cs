...
namespace RimWorld
{
	public static class PawnInventoryGenerator
	{
		...
		{
			PawnInventoryGenerator.<GiveDrugsIfAddicted>c__AnonStorey2D7 <GiveDrugsIfAddicted>c__AnonStorey2D = new PawnInventoryGenerator.<GiveDrugsIfAddicted>c__AnonStorey2D7();
