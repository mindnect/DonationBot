...
namespace RimWorld
{
	public abstract class WorkGiver_Scanner : WorkGiver
	{
		...
		{
			WorkGiver_Scanner.<PotentialWorkCellsGlobal>c__Iterator57 <PotentialWorkCellsGlobal>c__Iterator = new WorkGiver_Scanner.<PotentialWorkCellsGlobal>c__Iterator57();
			WorkGiver_Scanner.<PotentialWorkCellsGlobal>c__Iterator57 expr_07 = <PotentialWorkCellsGlobal>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
