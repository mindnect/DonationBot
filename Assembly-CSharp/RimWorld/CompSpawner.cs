...
namespace RimWorld
{
	public class CompSpawner : ThingComp
	{
		...
		{
			CompSpawner.<CompGetGizmosExtra>c__Iterator14F <CompGetGizmosExtra>c__Iterator14F = new CompSpawner.<CompGetGizmosExtra>c__Iterator14F();
			<CompGetGizmosExtra>c__Iterator14F.<>f__this = this;
			CompSpawner.<CompGetGizmosExtra>c__Iterator14F expr_0E = <CompGetGizmosExtra>c__Iterator14F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
