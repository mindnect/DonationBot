...
namespace RimWorld
{
	public static class LoadTransportersJobUtility
	{
		...
		{
			return transporter.AnythingLeftToLoad && pawn.health.capacities.CapableOf(PawnCapacityDefOf.Manipulation) && pawn.CanReserveAndReach(transporter.parent, PathEndMode.Touch, pawn.NormalMaxDanger(), 1) && LoadTransportersJobUtility.FindThingToLoad(pawn, transporter) != null;
		}
