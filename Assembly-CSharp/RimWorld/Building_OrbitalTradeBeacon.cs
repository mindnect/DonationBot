...
namespace RimWorld
{
	public class Building_OrbitalTradeBeacon : Building
	{
		...
		{
			Building_OrbitalTradeBeacon.<GetGizmos>c__Iterator13F <GetGizmos>c__Iterator13F = new Building_OrbitalTradeBeacon.<GetGizmos>c__Iterator13F();
			<GetGizmos>c__Iterator13F.<>f__this = this;
			Building_OrbitalTradeBeacon.<GetGizmos>c__Iterator13F expr_0E = <GetGizmos>c__Iterator13F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			Building_OrbitalTradeBeacon.<AllPowered>c__Iterator140 <AllPowered>c__Iterator = new Building_OrbitalTradeBeacon.<AllPowered>c__Iterator140();
			<AllPowered>c__Iterator.map = map;
			<AllPowered>c__Iterator.<$>map = map;
			Building_OrbitalTradeBeacon.<AllPowered>c__Iterator140 expr_15 = <AllPowered>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
