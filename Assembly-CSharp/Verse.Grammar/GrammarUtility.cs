...
namespace Verse.Grammar
{
	public static class GrammarUtility
	{
		...
		{
			GrammarUtility.<RulesForPawn>c__Iterator1C7 <RulesForPawn>c__Iterator1C = new GrammarUtility.<RulesForPawn>c__Iterator1C7();
			...
			<RulesForPawn>c__Iterator1C.<$>faction = faction;
			<RulesForPawn>c__Iterator1C.<$>gender = gender;
			GrammarUtility.<RulesForPawn>c__Iterator1C7 expr_4F = <RulesForPawn>c__Iterator1C;
			expr_4F.$PC = -2;
			return expr_4F;
		}
	}
