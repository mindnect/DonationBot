...
namespace RimWorld.BaseGen
{
	public class SymbolResolver_FactionBase : SymbolResolver
	{
		...
		private static readonly FloatRange NeolithicPawnsPoints = new FloatRange(750f, 1200f);

		private static readonly FloatRange NonNeolithicPawnsPoints = new FloatRange(1200f, 1800f);
