...
namespace Verse.Sound
{
	public class SubSoundDef : Editable
	{
		...
		{
			SubSoundDef.<ConfigErrors>c__Iterator1BA <ConfigErrors>c__Iterator1BA = new SubSoundDef.<ConfigErrors>c__Iterator1BA();
			<ConfigErrors>c__Iterator1BA.<>f__this = this;
			SubSoundDef.<ConfigErrors>c__Iterator1BA expr_0E = <ConfigErrors>c__Iterator1BA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
