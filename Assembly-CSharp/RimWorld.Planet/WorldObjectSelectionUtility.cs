...
namespace RimWorld.Planet
{
	public static class WorldObjectSelectionUtility
	{
		...
		{
			WorldObjectSelectionUtility.<MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator183 <MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator = new WorldObjectSelectionUtility.<MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator183();
			<MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator.rect = rect;
			<MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator.<$>rect = rect;
			WorldObjectSelectionUtility.<MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator183 expr_15 = <MultiSelectableWorldObjectsInScreenRectDistinct>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
