...
namespace RimWorld.Planet
{
	...
	public class WorldObject : ILoadReferenceable, IExposable, ISelectable
	{
		...
		{
			WorldObject.<GetGizmos>c__IteratorE9 <GetGizmos>c__IteratorE = new WorldObject.<GetGizmos>c__IteratorE9();
			WorldObject.<GetGizmos>c__IteratorE9 expr_07 = <GetGizmos>c__IteratorE;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			WorldObject.<GetFloatMenuOptions>c__IteratorEA <GetFloatMenuOptions>c__IteratorEA = new WorldObject.<GetFloatMenuOptions>c__IteratorEA();
			WorldObject.<GetFloatMenuOptions>c__IteratorEA expr_07 = <GetFloatMenuOptions>c__IteratorEA;
			expr_07.$PC = -2;
			return expr_07;
		}
