...
namespace Verse.AI
{
	public class JobDriver_AttackMelee : JobDriver
	{
		...
		{
			JobDriver_AttackMelee.<MakeNewToils>c__Iterator193 <MakeNewToils>c__Iterator = new JobDriver_AttackMelee.<MakeNewToils>c__Iterator193();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_AttackMelee.<MakeNewToils>c__Iterator193 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
