...
namespace Verse.AI
{
	public static class Toils_JobTransforms
	{
		...
		{
			Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19A <IngredientPlaceCellsInOrder>c__Iterator19A = new Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19A();
			<IngredientPlaceCellsInOrder>c__Iterator19A.billGiver = billGiver;
			<IngredientPlaceCellsInOrder>c__Iterator19A.<$>billGiver = billGiver;
			Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19A expr_15 = <IngredientPlaceCellsInOrder>c__Iterator19A;
			expr_15.$PC = -2;
			return expr_15;
		}
