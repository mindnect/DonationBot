...
namespace Verse.AI
{
	public class Toils_Haul
	{
		...
		public static Toil StartCarryThing(TargetIndex haulableInd, bool putRemainderInQueue = false)
		{
			Toil toil = new Toil();
			toil.initAction = delegate
			{
				...
				if (num3 < stackCount)
				{
					int num4 = curJob.count - actor.carryTracker.innerContainer.TotalStackCountOfDef(thing.def);
