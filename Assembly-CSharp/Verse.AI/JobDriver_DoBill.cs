...
namespace Verse.AI
{
	public class JobDriver_DoBill : JobDriver
	{
		...
		{
			JobDriver_DoBill.<MakeNewToils>c__Iterator197 <MakeNewToils>c__Iterator = new JobDriver_DoBill.<MakeNewToils>c__Iterator197();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_DoBill.<MakeNewToils>c__Iterator197 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
