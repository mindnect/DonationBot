...
namespace Verse.AI
{
	public class Pawn_MindState : IExposable
	{
		...
		{
			Pawn_MindState.<GetGizmos>c__Iterator19C <GetGizmos>c__Iterator19C = new Pawn_MindState.<GetGizmos>c__Iterator19C();
			<GetGizmos>c__Iterator19C.<>f__this = this;
			Pawn_MindState.<GetGizmos>c__Iterator19C expr_0E = <GetGizmos>c__Iterator19C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
