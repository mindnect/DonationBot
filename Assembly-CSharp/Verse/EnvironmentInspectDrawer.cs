...
namespace Verse
{
	internal static class EnvironmentInspectDrawer
	{
		...
		{
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 <DrawInfoWindow>c__AnonStorey = new EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515();
			...
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_89_cp_0 = <DrawInfoWindow>c__AnonStorey;
			expr_89_cp_0.windowRect.height = expr_89_cp_0.windowRect.height + 25f;
			if (<DrawInfoWindow>c__AnonStorey.roomValid)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_AB_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_AB_cp_0.windowRect.height = expr_AB_cp_0.windowRect.height + 13f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_C2_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_C2_cp_0.windowRect.height = expr_C2_cp_0.windowRect.height + 23f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_D9_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_D9_cp_0.windowRect.height = expr_D9_cp_0.windowRect.height + (float)EnvironmentInspectDrawer.DisplayedRoomStatsCount * 25f;
			}
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_F7_cp_0 = <DrawInfoWindow>c__AnonStorey;
			expr_F7_cp_0.windowRect.x = expr_F7_cp_0.windowRect.x + 26f;
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_10E_cp_0 = <DrawInfoWindow>c__AnonStorey;
			...
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_13B_cp_0 = <DrawInfoWindow>c__AnonStorey;
			...
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey515 expr_174_cp_0 = <DrawInfoWindow>c__AnonStorey;
