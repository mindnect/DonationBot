...
namespace Verse
{
	public static class ZoneColorUtility
	{
		...
		{
			ZoneColorUtility.<GrowingZoneColors>c__Iterator1E4 <GrowingZoneColors>c__Iterator1E = new ZoneColorUtility.<GrowingZoneColors>c__Iterator1E4();
			ZoneColorUtility.<GrowingZoneColors>c__Iterator1E4 expr_07 = <GrowingZoneColors>c__Iterator1E;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			ZoneColorUtility.<StorageZoneColors>c__Iterator1E5 <StorageZoneColors>c__Iterator1E = new ZoneColorUtility.<StorageZoneColors>c__Iterator1E5();
			ZoneColorUtility.<StorageZoneColors>c__Iterator1E5 expr_07 = <StorageZoneColors>c__Iterator1E;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
