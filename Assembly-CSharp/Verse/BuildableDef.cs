...
namespace Verse
{
	public abstract class BuildableDef : Def
	{
		...
		{
			BuildableDef.<ConfigErrors>c__Iterator1A2 <ConfigErrors>c__Iterator1A = new BuildableDef.<ConfigErrors>c__Iterator1A2();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			BuildableDef.<ConfigErrors>c__Iterator1A2 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
