...
namespace Verse
{
	public class RaceProperties
	{
		...
		{
			RaceProperties.<ConfigErrors>c__Iterator1A6 <ConfigErrors>c__Iterator1A = new RaceProperties.<ConfigErrors>c__Iterator1A6();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			RaceProperties.<ConfigErrors>c__Iterator1A6 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			RaceProperties.<SpecialDisplayStats>c__Iterator1A7 <SpecialDisplayStats>c__Iterator1A = new RaceProperties.<SpecialDisplayStats>c__Iterator1A7();
			<SpecialDisplayStats>c__Iterator1A.parentDef = parentDef;
			<SpecialDisplayStats>c__Iterator1A.<$>parentDef = parentDef;
			<SpecialDisplayStats>c__Iterator1A.<>f__this = this;
			RaceProperties.<SpecialDisplayStats>c__Iterator1A7 expr_1C = <SpecialDisplayStats>c__Iterator1A;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
