...
namespace Verse
{
	public sealed class ListerBuildings
	{
		...
		{
			ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1D3 <AllBuildingsColonistOfDef>c__Iterator1D = new ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1D3();
			<AllBuildingsColonistOfDef>c__Iterator1D.def = def;
			<AllBuildingsColonistOfDef>c__Iterator1D.<$>def = def;
			<AllBuildingsColonistOfDef>c__Iterator1D.<>f__this = this;
			ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1D3 expr_1C = <AllBuildingsColonistOfDef>c__Iterator1D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1D4<T> <AllBuildingsColonistOfClass>c__Iterator1D = new ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1D4<T>();
			<AllBuildingsColonistOfClass>c__Iterator1D.<>f__this = this;
			ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1D4<T> expr_0E = <AllBuildingsColonistOfClass>c__Iterator1D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
