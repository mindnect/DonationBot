...
namespace Verse
{
	public class ProjectileProperties
	{
		...
		{
			ProjectileProperties.<ConfigErrors>c__Iterator1A5 <ConfigErrors>c__Iterator1A = new ProjectileProperties.<ConfigErrors>c__Iterator1A5();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			ProjectileProperties.<ConfigErrors>c__Iterator1A5 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
