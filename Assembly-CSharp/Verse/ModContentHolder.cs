...
namespace Verse
{
	public class ModContentHolder<T> where T : class
	{
		...
		{
			ModContentHolder<T>.<GetAllUnderPath>c__Iterator1E7 <GetAllUnderPath>c__Iterator1E = new ModContentHolder<T>.<GetAllUnderPath>c__Iterator1E7();
			<GetAllUnderPath>c__Iterator1E.pathRoot = pathRoot;
			<GetAllUnderPath>c__Iterator1E.<$>pathRoot = pathRoot;
			<GetAllUnderPath>c__Iterator1E.<>f__this = this;
			ModContentHolder<T>.<GetAllUnderPath>c__Iterator1E7 expr_1C = <GetAllUnderPath>c__Iterator1E;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
