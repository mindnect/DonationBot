...
namespace Verse
{
	public class ThingDef : BuildableDef
	{
		...
		{
			ThingDef.<ConfigErrors>c__Iterator1C1 <ConfigErrors>c__Iterator1C = new ThingDef.<ConfigErrors>c__Iterator1C1();
			<ConfigErrors>c__Iterator1C.<>f__this = this;
			ThingDef.<ConfigErrors>c__Iterator1C1 expr_0E = <ConfigErrors>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			ThingDef.<SpecialDisplayStats>c__Iterator1C2 <SpecialDisplayStats>c__Iterator1C = new ThingDef.<SpecialDisplayStats>c__Iterator1C2();
			<SpecialDisplayStats>c__Iterator1C.<>f__this = this;
			ThingDef.<SpecialDisplayStats>c__Iterator1C2 expr_0E = <SpecialDisplayStats>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
