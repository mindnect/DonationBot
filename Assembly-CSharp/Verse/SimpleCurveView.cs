...
namespace Verse
{
	public class SimpleCurveView
	{
		...
		public IEnumerable<float> DebugInputValues
		{
			get
			{
				SimpleCurveView.<>c__Iterator20B <>c__Iterator20B = new SimpleCurveView.<>c__Iterator20B();
				<>c__Iterator20B.<>f__this = this;
				SimpleCurveView.<>c__Iterator20B expr_0E = <>c__Iterator20B;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
