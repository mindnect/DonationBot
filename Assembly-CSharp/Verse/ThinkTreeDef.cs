...
namespace Verse
{
	public class ThinkTreeDef : Def
	{
		...
		{
			ThinkTreeDef.<ConfigErrors>c__Iterator1C3 <ConfigErrors>c__Iterator1C = new ThinkTreeDef.<ConfigErrors>c__Iterator1C3();
			<ConfigErrors>c__Iterator1C.<>f__this = this;
			ThinkTreeDef.<ConfigErrors>c__Iterator1C3 expr_0E = <ConfigErrors>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
