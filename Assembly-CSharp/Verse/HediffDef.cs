...
namespace Verse
{
	public class HediffDef : Def
	{
		...
		{
			HediffDef.<ConfigErrors>c__Iterator1A9 <ConfigErrors>c__Iterator1A = new HediffDef.<ConfigErrors>c__Iterator1A9();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			HediffDef.<ConfigErrors>c__Iterator1A9 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffDef.<SpecialDisplayStats>c__Iterator1AA <SpecialDisplayStats>c__Iterator1AA = new HediffDef.<SpecialDisplayStats>c__Iterator1AA();
			<SpecialDisplayStats>c__Iterator1AA.<>f__this = this;
			HediffDef.<SpecialDisplayStats>c__Iterator1AA expr_0E = <SpecialDisplayStats>c__Iterator1AA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
