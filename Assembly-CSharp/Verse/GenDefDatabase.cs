...
namespace Verse
{
	public static class GenDefDatabase
	{
		...
		{
			GenDefDatabase.<AllDefTypesWithDatabases>c__Iterator19E <AllDefTypesWithDatabases>c__Iterator19E = new GenDefDatabase.<AllDefTypesWithDatabases>c__Iterator19E();
			GenDefDatabase.<AllDefTypesWithDatabases>c__Iterator19E expr_07 = <AllDefTypesWithDatabases>c__Iterator19E;
			expr_07.$PC = -2;
			return expr_07;
		}
