...
namespace Verse
{
	public static class GenAdj
	{
		...
		{
			GenAdj.<CellsOccupiedBy>c__Iterator211 <CellsOccupiedBy>c__Iterator = new GenAdj.<CellsOccupiedBy>c__Iterator211();
			<CellsOccupiedBy>c__Iterator.t = t;
			<CellsOccupiedBy>c__Iterator.<$>t = t;
			GenAdj.<CellsOccupiedBy>c__Iterator211 expr_15 = <CellsOccupiedBy>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		public static IEnumerable<IntVec3> CellsOccupiedBy(IntVec3 center, Rot4 rotation, IntVec2 size)
		{
			...
			<CellsOccupiedBy>c__Iterator.<$>size = size;
			<CellsOccupiedBy>c__Iterator.<$>rotation = rotation;
			GenAdj.<CellsOccupiedBy>c__Iterator212 expr_31 = <CellsOccupiedBy>c__Iterator;
			expr_31.$PC = -2;
			return expr_31;
		}
		...
		{
			GenAdj.<CellsAdjacent8Way>c__Iterator213 <CellsAdjacent8Way>c__Iterator = new GenAdj.<CellsAdjacent8Way>c__Iterator213();
			<CellsAdjacent8Way>c__Iterator.pack = pack;
			<CellsAdjacent8Way>c__Iterator.<$>pack = pack;
			GenAdj.<CellsAdjacent8Way>c__Iterator213 expr_15 = <CellsAdjacent8Way>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		public static IEnumerable<IntVec3> CellsAdjacent8Way(IntVec3 thingCenter, Rot4 thingRot, IntVec2 thingSize)
		{
			...
			<CellsAdjacent8Way>c__Iterator.<$>thingSize = thingSize;
			<CellsAdjacent8Way>c__Iterator.<$>thingRot = thingRot;
			GenAdj.<CellsAdjacent8Way>c__Iterator214 expr_31 = <CellsAdjacent8Way>c__Iterator;
			expr_31.$PC = -2;
			return expr_31;
		}
		...
		{
			GenAdj.<CellsAdjacentCardinal>c__Iterator215 <CellsAdjacentCardinal>c__Iterator = new GenAdj.<CellsAdjacentCardinal>c__Iterator215();
			...
			<CellsAdjacentCardinal>c__Iterator.<$>size = size;
			<CellsAdjacentCardinal>c__Iterator.<$>rot = rot;
			GenAdj.<CellsAdjacentCardinal>c__Iterator215 expr_31 = <CellsAdjacentCardinal>c__Iterator;
			expr_31.$PC = -2;
			return expr_31;
		}
		...
		{
			GenAdj.<CellsAdjacentAlongEdge>c__Iterator216 <CellsAdjacentAlongEdge>c__Iterator = new GenAdj.<CellsAdjacentAlongEdge>c__Iterator216();
			...
			<CellsAdjacentAlongEdge>c__Iterator.<$>thingRot = thingRot;
			<CellsAdjacentAlongEdge>c__Iterator.<$>dir = dir;
			GenAdj.<CellsAdjacentAlongEdge>c__Iterator216 expr_3F = <CellsAdjacentAlongEdge>c__Iterator;
			expr_3F.$PC = -2;
			return expr_3F;
		}
		...
		{
			GenAdj.<CellsAdjacent8WayAndInside>c__Iterator217 <CellsAdjacent8WayAndInside>c__Iterator = new GenAdj.<CellsAdjacent8WayAndInside>c__Iterator217();
			<CellsAdjacent8WayAndInside>c__Iterator.thing = thing;
			<CellsAdjacent8WayAndInside>c__Iterator.<$>thing = thing;
			GenAdj.<CellsAdjacent8WayAndInside>c__Iterator217 expr_15 = <CellsAdjacent8WayAndInside>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
