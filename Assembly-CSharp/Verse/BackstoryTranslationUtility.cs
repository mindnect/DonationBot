...
namespace Verse
{
	public static class BackstoryTranslationUtility
	{
		...
		{
			BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1C8 <BackstoryTranslationElements>c__Iterator1C = new BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1C8();
			<BackstoryTranslationElements>c__Iterator1C.lang = lang;
			<BackstoryTranslationElements>c__Iterator1C.<$>lang = lang;
			BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1C8 expr_15 = <BackstoryTranslationElements>c__Iterator1C;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1C9 <MissingBackstoryTranslations>c__Iterator1C = new BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1C9();
			<MissingBackstoryTranslations>c__Iterator1C.lang = lang;
			<MissingBackstoryTranslations>c__Iterator1C.<$>lang = lang;
			BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1C9 expr_15 = <MissingBackstoryTranslations>c__Iterator1C;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
