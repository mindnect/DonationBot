...
namespace Verse
{
	public class HediffSet : IExposable
	{
		...
		{
			HediffSet.<GetHediffs>c__Iterator1EF<T> <GetHediffs>c__Iterator1EF = new HediffSet.<GetHediffs>c__Iterator1EF<T>();
			<GetHediffs>c__Iterator1EF.<>f__this = this;
			HediffSet.<GetHediffs>c__Iterator1EF<T> expr_0E = <GetHediffs>c__Iterator1EF;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffSet.<GetHediffsVerbs>c__Iterator1F0 <GetHediffsVerbs>c__Iterator1F = new HediffSet.<GetHediffsVerbs>c__Iterator1F0();
			<GetHediffsVerbs>c__Iterator1F.<>f__this = this;
			HediffSet.<GetHediffsVerbs>c__Iterator1F0 expr_0E = <GetHediffsVerbs>c__Iterator1F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffSet.<GetInjuriesTendable>c__Iterator1F1 <GetInjuriesTendable>c__Iterator1F = new HediffSet.<GetInjuriesTendable>c__Iterator1F1();
			<GetInjuriesTendable>c__Iterator1F.<>f__this = this;
			HediffSet.<GetInjuriesTendable>c__Iterator1F1 expr_0E = <GetInjuriesTendable>c__Iterator1F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffSet.<GetNaturallyHealingInjuredParts>c__Iterator1F2 <GetNaturallyHealingInjuredParts>c__Iterator1F = new HediffSet.<GetNaturallyHealingInjuredParts>c__Iterator1F2();
			<GetNaturallyHealingInjuredParts>c__Iterator1F.<>f__this = this;
			HediffSet.<GetNaturallyHealingInjuredParts>c__Iterator1F2 expr_0E = <GetNaturallyHealingInjuredParts>c__Iterator1F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffSet.<GetNotMissingParts>c__Iterator1F3 <GetNotMissingParts>c__Iterator1F = new HediffSet.<GetNotMissingParts>c__Iterator1F3();
			...
			HediffSet.<GetNotMissingParts>c__Iterator1F3 expr_2A = <GetNotMissingParts>c__Iterator1F;
			expr_2A.$PC = -2;
			return expr_2A;
		}
		...
		{
			HediffSet.<GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F4 <GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F = new HediffSet.<GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F4();
			<GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F.<>f__this = this;
			HediffSet.<GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F4 expr_0E = <GetTendableNonInjuryNonMissingPartHediffs>c__Iterator1F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
