...
namespace Verse
{
	public class Building : ThingWithComps
	{
		...
		{
			Building.<GetGizmos>c__Iterator126 <GetGizmos>c__Iterator = new Building.<GetGizmos>c__Iterator126();
			<GetGizmos>c__Iterator.<>f__this = this;
			Building.<GetGizmos>c__Iterator126 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
