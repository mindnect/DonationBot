...
namespace Verse
{
	public class JobDef : Def
	{
		...
		{
			JobDef.<ConfigErrors>c__Iterator1AC <ConfigErrors>c__Iterator1AC = new JobDef.<ConfigErrors>c__Iterator1AC();
			<ConfigErrors>c__Iterator1AC.<>f__this = this;
			JobDef.<ConfigErrors>c__Iterator1AC expr_0E = <ConfigErrors>c__Iterator1AC;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
