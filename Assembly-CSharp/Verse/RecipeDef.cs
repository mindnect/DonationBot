...
namespace Verse
{
	public class RecipeDef : Def
	{
		...
		public IEnumerable<ThingDef> AllRecipeUsers
		{
			get
			{
				RecipeDef.<>c__Iterator1B1 <>c__Iterator1B = new RecipeDef.<>c__Iterator1B1();
				<>c__Iterator1B.<>f__this = this;
				RecipeDef.<>c__Iterator1B1 expr_0E = <>c__Iterator1B;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			RecipeDef.<PotentiallyMissingIngredients>c__Iterator1B2 <PotentiallyMissingIngredients>c__Iterator1B = new RecipeDef.<PotentiallyMissingIngredients>c__Iterator1B2();
			...
			RecipeDef.<PotentiallyMissingIngredients>c__Iterator1B2 expr_2A = <PotentiallyMissingIngredients>c__Iterator1B;
			expr_2A.$PC = -2;
			return expr_2A;
		}
		...
		{
			RecipeDef.<ConfigErrors>c__Iterator1B3 <ConfigErrors>c__Iterator1B = new RecipeDef.<ConfigErrors>c__Iterator1B3();
			<ConfigErrors>c__Iterator1B.<>f__this = this;
			RecipeDef.<ConfigErrors>c__Iterator1B3 expr_0E = <ConfigErrors>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
