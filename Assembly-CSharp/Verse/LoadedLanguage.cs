...
namespace Verse
{
	public class LoadedLanguage
	{
		...
		public IEnumerable<string> FolderPaths
		{
			get
			{
				LoadedLanguage.<>c__Iterator1CC <>c__Iterator1CC = new LoadedLanguage.<>c__Iterator1CC();
				<>c__Iterator1CC.<>f__this = this;
				LoadedLanguage.<>c__Iterator1CC expr_0E = <>c__Iterator1CC;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
