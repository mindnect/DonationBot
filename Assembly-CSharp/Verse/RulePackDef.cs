...
namespace Verse
{
	public class RulePackDef : Def
	{
		...
		{
			RulePackDef.<ConfigErrors>c__Iterator1B5 <ConfigErrors>c__Iterator1B = new RulePackDef.<ConfigErrors>c__Iterator1B5();
			<ConfigErrors>c__Iterator1B.<>f__this = this;
			RulePackDef.<ConfigErrors>c__Iterator1B5 expr_0E = <ConfigErrors>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
