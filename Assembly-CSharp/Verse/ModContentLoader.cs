...
namespace Verse
{
	public static class ModContentLoader<T> where T : class
	{
		...
		{
			ModContentLoader<T>.<LoadAllForMod>c__Iterator1E8 <LoadAllForMod>c__Iterator1E = new ModContentLoader<T>.<LoadAllForMod>c__Iterator1E8();
			<LoadAllForMod>c__Iterator1E.mod = mod;
			<LoadAllForMod>c__Iterator1E.<$>mod = mod;
			ModContentLoader<T>.<LoadAllForMod>c__Iterator1E8 expr_15 = <LoadAllForMod>c__Iterator1E;
			expr_15.$PC = -2;
			return expr_15;
		}
