...
namespace Verse
{
	public class BodyPartDef : Def
	{
		...
		{
			BodyPartDef.<ConfigErrors>c__Iterator1A1 <ConfigErrors>c__Iterator1A = new BodyPartDef.<ConfigErrors>c__Iterator1A1();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			BodyPartDef.<ConfigErrors>c__Iterator1A1 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
