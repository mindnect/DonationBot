...
namespace Verse
{
	public class PawnKindDef : Def
	{
		...
		{
			PawnKindDef.<ConfigErrors>c__Iterator1B0 <ConfigErrors>c__Iterator1B = new PawnKindDef.<ConfigErrors>c__Iterator1B0();
			<ConfigErrors>c__Iterator1B.<>f__this = this;
			PawnKindDef.<ConfigErrors>c__Iterator1B0 expr_0E = <ConfigErrors>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
