...
namespace Verse
{
	public class TerrainDef : BuildableDef
	{
		...
		{
			TerrainDef.<ConfigErrors>c__Iterator1BB <ConfigErrors>c__Iterator1BB = new TerrainDef.<ConfigErrors>c__Iterator1BB();
			<ConfigErrors>c__Iterator1BB.<>f__this = this;
			TerrainDef.<ConfigErrors>c__Iterator1BB expr_0E = <ConfigErrors>c__Iterator1BB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
