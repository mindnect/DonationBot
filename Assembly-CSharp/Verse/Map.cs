...
namespace Verse
{
	public sealed class Map : IIncidentTarget, ILoadReferenceable, IExposable
	{
		...
		public IEnumerable<IntVec3> AllCells
		{
			get
			{
				Map.<>c__Iterator1D8 <>c__Iterator1D = new Map.<>c__Iterator1D8();
				<>c__Iterator1D.<>f__this = this;
				Map.<>c__Iterator1D8 expr_0E = <>c__Iterator1D;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Map.<GetEnumerator>c__Iterator1D9 <GetEnumerator>c__Iterator1D = new Map.<GetEnumerator>c__Iterator1D9();
			<GetEnumerator>c__Iterator1D.<>f__this = this;
			return <GetEnumerator>c__Iterator1D;
		}
		...
		public void MapPostTick()
		{
			...
			Profiler.EndSample();
			Profiler.BeginSample("MapConditionManager.MapConditionManagerTick()");
			try
			{
		...
		public void MapUpdate()
		{
			...
			Profiler.EndSample();
			Profiler.BeginSample("RegionAndRoomUpdater.ResolveRegionAndRoomChanges");
			...
			if (!worldRenderedNow && Find.VisibleMap == this)
			{
				...
				Profiler.EndSample();
				Profiler.BeginSample("MapConditionManagerDraw");
			...
			Profiler.EndSample();
			Profiler.BeginSample("DeepResourceGridDraw()");
