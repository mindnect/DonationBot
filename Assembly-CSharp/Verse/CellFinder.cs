...
namespace Verse
{
	public static class CellFinder
	{
		...
		{
			CellFinder.<GetAdjacentCells>c__Iterator20E <GetAdjacentCells>c__Iterator20E = new CellFinder.<GetAdjacentCells>c__Iterator20E();
			<GetAdjacentCells>c__Iterator20E.x = x;
			<GetAdjacentCells>c__Iterator20E.pawn = pawn;
			<GetAdjacentCells>c__Iterator20E.radius = radius;
			<GetAdjacentCells>c__Iterator20E.<$>x = x;
			<GetAdjacentCells>c__Iterator20E.<$>pawn = pawn;
			<GetAdjacentCells>c__Iterator20E.<$>radius = radius;
			CellFinder.<GetAdjacentCells>c__Iterator20E expr_31 = <GetAdjacentCells>c__Iterator20E;
			expr_31.$PC = -2;
			return expr_31;
		}
	}
