...
namespace Verse
{
	public class BodyDef : Def
	{
		...
		{
			BodyDef.<GetParts>c__Iterator19F <GetParts>c__Iterator19F = new BodyDef.<GetParts>c__Iterator19F();
			<GetParts>c__Iterator19F.activity = activity;
			<GetParts>c__Iterator19F.activityGroup = activityGroup;
			<GetParts>c__Iterator19F.<$>activity = activity;
			<GetParts>c__Iterator19F.<$>activityGroup = activityGroup;
			<GetParts>c__Iterator19F.<>f__this = this;
			BodyDef.<GetParts>c__Iterator19F expr_2A = <GetParts>c__Iterator19F;
			expr_2A.$PC = -2;
			return expr_2A;
		}
		...
		{
			BodyDef.<ConfigErrors>c__Iterator1A0 <ConfigErrors>c__Iterator1A = new BodyDef.<ConfigErrors>c__Iterator1A0();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			BodyDef.<ConfigErrors>c__Iterator1A0 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
