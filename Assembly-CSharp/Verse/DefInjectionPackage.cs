...
namespace Verse
{
	public class DefInjectionPackage
	{
		...
		{
			DefInjectionPackage.<MissingInjections>c__Iterator1CA <MissingInjections>c__Iterator1CA = new DefInjectionPackage.<MissingInjections>c__Iterator1CA();
			<MissingInjections>c__Iterator1CA.<>f__this = this;
			DefInjectionPackage.<MissingInjections>c__Iterator1CA expr_0E = <MissingInjections>c__Iterator1CA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CB <MissingInjectionsFromDef>c__Iterator1CB = new DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CB();
			<MissingInjectionsFromDef>c__Iterator1CB.def = def;
			<MissingInjectionsFromDef>c__Iterator1CB.<$>def = def;
			<MissingInjectionsFromDef>c__Iterator1CB.<>f__this = this;
			DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CB expr_1C = <MissingInjectionsFromDef>c__Iterator1CB;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
