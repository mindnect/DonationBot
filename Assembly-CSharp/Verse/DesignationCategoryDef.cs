...
namespace Verse
{
	public class DesignationCategoryDef : Def
	{
		...
		public IEnumerable<Designator> ResolvedAllowedDesignators
		{
			get
			{
				DesignationCategoryDef.<>c__Iterator1A8 <>c__Iterator1A = new DesignationCategoryDef.<>c__Iterator1A8();
				<>c__Iterator1A.<>f__this = this;
				DesignationCategoryDef.<>c__Iterator1A8 expr_0E = <>c__Iterator1A;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
