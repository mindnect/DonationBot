...
namespace Verse
{
	public static class Gen
	{
		...
		{
			Gen.<GetAllSelectedItems>c__Iterator20F<T> <GetAllSelectedItems>c__Iterator20F = new Gen.<GetAllSelectedItems>c__Iterator20F<T>();
			<GetAllSelectedItems>c__Iterator20F.value = value;
			<GetAllSelectedItems>c__Iterator20F.<$>value = value;
			Gen.<GetAllSelectedItems>c__Iterator20F<T> expr_15 = <GetAllSelectedItems>c__Iterator20F;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			Gen.<YieldSingle>c__Iterator210<T> <YieldSingle>c__Iterator = new Gen.<YieldSingle>c__Iterator210<T>();
			<YieldSingle>c__Iterator.val = val;
			<YieldSingle>c__Iterator.<$>val = val;
			Gen.<YieldSingle>c__Iterator210<T> expr_15 = <YieldSingle>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
