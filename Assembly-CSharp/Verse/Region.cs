...
namespace Verse
{
	public sealed class Region
	{
		...
		public IEnumerable<IntVec3> Cells
		{
			get
			{
				Region.<>c__Iterator1DA <>c__Iterator1DA = new Region.<>c__Iterator1DA();
				<>c__Iterator1DA.<>f__this = this;
				Region.<>c__Iterator1DA expr_0E = <>c__Iterator1DA;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		public IEnumerable<Region> Neighbors
		{
			get
			{
				Region.<>c__Iterator1DB <>c__Iterator1DB = new Region.<>c__Iterator1DB();
				<>c__Iterator1DB.<>f__this = this;
				Region.<>c__Iterator1DB expr_0E = <>c__Iterator1DB;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		public IEnumerable<Region> NonPortalNeighbors
		{
			get
			{
				Region.<>c__Iterator1DC <>c__Iterator1DC = new Region.<>c__Iterator1DC();
				<>c__Iterator1DC.<>f__this = this;
				Region.<>c__Iterator1DC expr_0E = <>c__Iterator1DC;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
