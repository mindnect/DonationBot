...
namespace Verse
{
	public class MentalStateDef : Def
	{
		...
		{
			MentalStateDef.<ConfigErrors>c__Iterator1AE <ConfigErrors>c__Iterator1AE = new MentalStateDef.<ConfigErrors>c__Iterator1AE();
			<ConfigErrors>c__Iterator1AE.<>f__this = this;
			MentalStateDef.<ConfigErrors>c__Iterator1AE expr_0E = <ConfigErrors>c__Iterator1AE;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
