...
namespace Verse
{
	public class SimpleCurve : IEnumerable, IEnumerable<CurvePoint>
	{
		...
		{
			SimpleCurve.<GetEnumerator>c__Iterator20C <GetEnumerator>c__Iterator20C = new SimpleCurve.<GetEnumerator>c__Iterator20C();
			<GetEnumerator>c__Iterator20C.<>f__this = this;
			return <GetEnumerator>c__Iterator20C;
		}
		...
		{
			SimpleCurve.<ConfigErrors>c__Iterator20D <ConfigErrors>c__Iterator20D = new SimpleCurve.<ConfigErrors>c__Iterator20D();
			<ConfigErrors>c__Iterator20D.prefix = prefix;
			<ConfigErrors>c__Iterator20D.<$>prefix = prefix;
			<ConfigErrors>c__Iterator20D.<>f__this = this;
			SimpleCurve.<ConfigErrors>c__Iterator20D expr_1C = <ConfigErrors>c__Iterator20D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
