...
namespace Verse
{
	public static class GenTypes
	{
		...
		private static IEnumerable<Assembly> AllActiveAssemblies
		{
			get
			{
				GenTypes.<>c__Iterator21E <>c__Iterator21E = new GenTypes.<>c__Iterator21E();
				GenTypes.<>c__Iterator21E expr_07 = <>c__Iterator21E;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
		...
		public static IEnumerable<Type> AllTypes
		{
			get
			{
				GenTypes.<>c__Iterator21F <>c__Iterator21F = new GenTypes.<>c__Iterator21F();
				GenTypes.<>c__Iterator21F expr_07 = <>c__Iterator21F;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
		...
		{
			GenTypes.<InstantiableDescendantsAndSelf>c__Iterator220 <InstantiableDescendantsAndSelf>c__Iterator = new GenTypes.<InstantiableDescendantsAndSelf>c__Iterator220();
			<InstantiableDescendantsAndSelf>c__Iterator.baseType = baseType;
			<InstantiableDescendantsAndSelf>c__Iterator.<$>baseType = baseType;
			GenTypes.<InstantiableDescendantsAndSelf>c__Iterator220 expr_15 = <InstantiableDescendantsAndSelf>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
