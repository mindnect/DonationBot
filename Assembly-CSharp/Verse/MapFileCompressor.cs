...
namespace Verse
{
	public class MapFileCompressor : IExposable
	{
		...
		{
			MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CD <ThingsToSpawnAfterLoad>c__Iterator1CD = new MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CD();
			<ThingsToSpawnAfterLoad>c__Iterator1CD.<>f__this = this;
			MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CD expr_0E = <ThingsToSpawnAfterLoad>c__Iterator1CD;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
