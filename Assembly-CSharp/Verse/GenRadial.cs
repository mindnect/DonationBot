...
namespace Verse
{
	public static class GenRadial
	{
		...
		{
			GenRadial.<RadialPatternInRadius>c__Iterator21A <RadialPatternInRadius>c__Iterator21A = new GenRadial.<RadialPatternInRadius>c__Iterator21A();
			<RadialPatternInRadius>c__Iterator21A.radius = radius;
			<RadialPatternInRadius>c__Iterator21A.<$>radius = radius;
			GenRadial.<RadialPatternInRadius>c__Iterator21A expr_15 = <RadialPatternInRadius>c__Iterator21A;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			GenRadial.<RadialCellsAround>c__Iterator21B <RadialCellsAround>c__Iterator21B = new GenRadial.<RadialCellsAround>c__Iterator21B();
			<RadialCellsAround>c__Iterator21B.radius = radius;
			<RadialCellsAround>c__Iterator21B.useCenter = useCenter;
			<RadialCellsAround>c__Iterator21B.center = center;
			<RadialCellsAround>c__Iterator21B.<$>radius = radius;
			<RadialCellsAround>c__Iterator21B.<$>useCenter = useCenter;
			<RadialCellsAround>c__Iterator21B.<$>center = center;
			GenRadial.<RadialCellsAround>c__Iterator21B expr_31 = <RadialCellsAround>c__Iterator21B;
			expr_31.$PC = -2;
			return expr_31;
		}
		...
		{
			GenRadial.<RadialDistinctThingsAround>c__Iterator21C <RadialDistinctThingsAround>c__Iterator21C = new GenRadial.<RadialDistinctThingsAround>c__Iterator21C();
			<RadialDistinctThingsAround>c__Iterator21C.radius = radius;
			<RadialDistinctThingsAround>c__Iterator21C.useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator21C.center = center;
			<RadialDistinctThingsAround>c__Iterator21C.map = map;
			<RadialDistinctThingsAround>c__Iterator21C.<$>radius = radius;
			<RadialDistinctThingsAround>c__Iterator21C.<$>useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator21C.<$>center = center;
			<RadialDistinctThingsAround>c__Iterator21C.<$>map = map;
			GenRadial.<RadialDistinctThingsAround>c__Iterator21C expr_3F = <RadialDistinctThingsAround>c__Iterator21C;
			expr_3F.$PC = -2;
			return expr_3F;
		}
	}
