...
namespace Verse
{
	public class SoundDef : Def
	{
		...
		{
			SoundDef.<ConfigErrors>c__Iterator1B9 <ConfigErrors>c__Iterator1B = new SoundDef.<ConfigErrors>c__Iterator1B9();
			<ConfigErrors>c__Iterator1B.<>f__this = this;
			SoundDef.<ConfigErrors>c__Iterator1B9 expr_0E = <ConfigErrors>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
