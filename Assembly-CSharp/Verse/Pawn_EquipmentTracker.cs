...
namespace Verse
{
	public class Pawn_EquipmentTracker : IExposable
	{
		...
		public IEnumerable<Verb> AllEquipmentVerbs
		{
			get
			{
				Pawn_EquipmentTracker.<>c__Iterator1FA <>c__Iterator1FA = new Pawn_EquipmentTracker.<>c__Iterator1FA();
				<>c__Iterator1FA.<>f__this = this;
				Pawn_EquipmentTracker.<>c__Iterator1FA expr_0E = <>c__Iterator1FA;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FB <GetGizmos>c__Iterator1FB = new Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FB();
			<GetGizmos>c__Iterator1FB.<>f__this = this;
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FB expr_0E = <GetGizmos>c__Iterator1FB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
