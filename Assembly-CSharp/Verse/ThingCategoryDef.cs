...
namespace Verse
{
	public class ThingCategoryDef : Def
	{
		...
		public IEnumerable<ThingCategoryDef> Parents
		{
			get
			{
				ThingCategoryDef.<>c__Iterator1BC <>c__Iterator1BC = new ThingCategoryDef.<>c__Iterator1BC();
				<>c__Iterator1BC.<>f__this = this;
				ThingCategoryDef.<>c__Iterator1BC expr_0E = <>c__Iterator1BC;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
