...
namespace WebSocket
{
	internal class PayloadData : IEnumerable<byte>, IEnumerable
	{
		...
		public byte[] ApplicationData
		{
			get
			{
				if (this._extDataLength <= (long)0)
				{
					return this._data;
				}
				return this._data.SubArray<byte>(this._extDataLength, this._length - this._extDataLength);
			}
		}
		...
		public byte[] ExtensionData
		{
			get
			{
				...
				return this._data.SubArray<byte>((long)0, this._extDataLength);
			}
		}
		...
		{
			for (long i = (long)0; i < this._length; i = i + (long)1)
			{
