...
namespace WebSocket
{
	internal class HttpRequest : HttpBase
	{
		...
		public WebSocket.Net.AuthenticationResponse AuthenticationResponse
		{
			get
			{
				...
				return WebSocket.Net.AuthenticationResponse.Parse(item);
			}
		}
		...
		internal static HttpRequest Parse(string[] headerParts)
		{
			...
			return new HttpRequest(strArrays[0], strArrays[1], new Version(strArrays[2].Substring(5)), webHeaderCollection);
		}
