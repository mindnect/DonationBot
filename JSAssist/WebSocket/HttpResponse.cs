	...
	internal class HttpResponse : HttpBase
	{
		...
		public bool IsWebSocketResponse
		{
			get
			{
				...
				if (!(base.ProtocolVersion > HttpVersion.Version10) || !(this._code == "101") || !headers.Contains("Upgrade", "websocket"))
				{
					return false;
				}
		...
		internal static HttpResponse Parse(string[] headerParts)
		{
			...
			return new HttpResponse(strArrays[1], strArrays[2], new Version(strArrays[0].Substring(5)), webHeaderCollection);
		}
