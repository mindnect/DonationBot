...
namespace RimWorld
{
	public class CompForbiddable : ThingComp
	{
		...
		{
			CompForbiddable.<CompGetGizmosExtra>c__Iterator14A <CompGetGizmosExtra>c__Iterator14A = new CompForbiddable.<CompGetGizmosExtra>c__Iterator14A();
			<CompGetGizmosExtra>c__Iterator14A.<>f__this = this;
			CompForbiddable.<CompGetGizmosExtra>c__Iterator14A expr_0E = <CompGetGizmosExtra>c__Iterator14A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
