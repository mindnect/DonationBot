...
namespace RimWorld
{
	public static class StorageSettingsClipboard
	{
		...
		{
			StorageSettingsClipboard.<CopyPasteGizmosFor>c__Iterator135 <CopyPasteGizmosFor>c__Iterator = new StorageSettingsClipboard.<CopyPasteGizmosFor>c__Iterator135();
			<CopyPasteGizmosFor>c__Iterator.s = s;
			<CopyPasteGizmosFor>c__Iterator.<$>s = s;
			StorageSettingsClipboard.<CopyPasteGizmosFor>c__Iterator135 expr_15 = <CopyPasteGizmosFor>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
