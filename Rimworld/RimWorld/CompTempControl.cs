...
namespace RimWorld
{
	public class CompTempControl : ThingComp
	{
		...
		{
			CompTempControl.<CompGetGizmosExtra>c__Iterator152 <CompGetGizmosExtra>c__Iterator = new CompTempControl.<CompGetGizmosExtra>c__Iterator152();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompTempControl.<CompGetGizmosExtra>c__Iterator152 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
