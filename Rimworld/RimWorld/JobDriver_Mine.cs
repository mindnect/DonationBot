...
namespace RimWorld
{
	public class JobDriver_Mine : JobDriver
	{
		...
		{
			JobDriver_Mine.<MakeNewToils>c__Iterator34 <MakeNewToils>c__Iterator = new JobDriver_Mine.<MakeNewToils>c__Iterator34();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_Mine.<MakeNewToils>c__Iterator34 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
