...
namespace RimWorld
{
	public static class ScenarioMaker
	{
		...
		{
			ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator10F <RandomScenPartsOfCategory>c__Iterator10F = new ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator10F();
			<RandomScenPartsOfCategory>c__Iterator10F.count = count;
			<RandomScenPartsOfCategory>c__Iterator10F.scen = scen;
			<RandomScenPartsOfCategory>c__Iterator10F.cat = cat;
			<RandomScenPartsOfCategory>c__Iterator10F.<$>count = count;
			<RandomScenPartsOfCategory>c__Iterator10F.<$>scen = scen;
			<RandomScenPartsOfCategory>c__Iterator10F.<$>cat = cat;
			ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator10F expr_31 = <RandomScenPartsOfCategory>c__Iterator10F;
			expr_31.$PC = -2;
			return expr_31;
		}
