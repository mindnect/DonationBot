...
namespace RimWorld
{
	public class ScenPart_ScatterThingsAnywhere : ScenPart_ScatterThings
	{
		...
		{
			ScenPart_ScatterThingsAnywhere.<GetSummaryListEntries>c__Iterator107 <GetSummaryListEntries>c__Iterator = new ScenPart_ScatterThingsAnywhere.<GetSummaryListEntries>c__Iterator107();
			<GetSummaryListEntries>c__Iterator.tag = tag;
			<GetSummaryListEntries>c__Iterator.<$>tag = tag;
			<GetSummaryListEntries>c__Iterator.<>f__this = this;
			ScenPart_ScatterThingsAnywhere.<GetSummaryListEntries>c__Iterator107 expr_1C = <GetSummaryListEntries>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
