...
namespace RimWorld
{
	public class Building_CryptosleepCasket : Building_Casket
	{
		...
		{
			Building_CryptosleepCasket.<GetFloatMenuOptions>c__Iterator136 <GetFloatMenuOptions>c__Iterator = new Building_CryptosleepCasket.<GetFloatMenuOptions>c__Iterator136();
			<GetFloatMenuOptions>c__Iterator.myPawn = myPawn;
			<GetFloatMenuOptions>c__Iterator.<$>myPawn = myPawn;
			<GetFloatMenuOptions>c__Iterator.<>f__this = this;
			Building_CryptosleepCasket.<GetFloatMenuOptions>c__Iterator136 expr_1C = <GetFloatMenuOptions>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			Building_CryptosleepCasket.<GetGizmos>c__Iterator137 <GetGizmos>c__Iterator = new Building_CryptosleepCasket.<GetGizmos>c__Iterator137();
			<GetGizmos>c__Iterator.<>f__this = this;
			Building_CryptosleepCasket.<GetGizmos>c__Iterator137 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
