...
namespace RimWorld
{
	public class WorkGiver_RearmTraps : WorkGiver_Scanner
	{
		...
		{
			WorkGiver_RearmTraps.<PotentialWorkThingsGlobal>c__Iterator63 <PotentialWorkThingsGlobal>c__Iterator = new WorkGiver_RearmTraps.<PotentialWorkThingsGlobal>c__Iterator63();
			<PotentialWorkThingsGlobal>c__Iterator.pawn = pawn;
			<PotentialWorkThingsGlobal>c__Iterator.<$>pawn = pawn;
			WorkGiver_RearmTraps.<PotentialWorkThingsGlobal>c__Iterator63 expr_15 = <PotentialWorkThingsGlobal>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
