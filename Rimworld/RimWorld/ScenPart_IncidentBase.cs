...
namespace RimWorld
{
	public abstract class ScenPart_IncidentBase : ScenPart
	{
		...
		{
			ScenPart_IncidentBase.<GetSummaryListEntries>c__IteratorFF <GetSummaryListEntries>c__IteratorFF = new ScenPart_IncidentBase.<GetSummaryListEntries>c__IteratorFF();
			<GetSummaryListEntries>c__IteratorFF.tag = tag;
			<GetSummaryListEntries>c__IteratorFF.<$>tag = tag;
			<GetSummaryListEntries>c__IteratorFF.<>f__this = this;
			ScenPart_IncidentBase.<GetSummaryListEntries>c__IteratorFF expr_1C = <GetSummaryListEntries>c__IteratorFF;
			expr_1C.$PC = -2;
			return expr_1C;
		}
