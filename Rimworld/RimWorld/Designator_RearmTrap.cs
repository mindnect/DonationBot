...
namespace RimWorld
{
	public class Designator_RearmTrap : Designator
	{
		...
		{
			Designator_RearmTrap.<RearmablesInCell>c__Iterator174 <RearmablesInCell>c__Iterator = new Designator_RearmTrap.<RearmablesInCell>c__Iterator174();
			<RearmablesInCell>c__Iterator.c = c;
			<RearmablesInCell>c__Iterator.<$>c = c;
			<RearmablesInCell>c__Iterator.<>f__this = this;
			Designator_RearmTrap.<RearmablesInCell>c__Iterator174 expr_1C = <RearmablesInCell>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
