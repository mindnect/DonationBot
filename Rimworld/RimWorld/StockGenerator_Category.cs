...
namespace RimWorld
{
	public class StockGenerator_Category : StockGenerator
	{
		...
		{
			StockGenerator_Category.<GenerateThings>c__Iterator15F <GenerateThings>c__Iterator15F = new StockGenerator_Category.<GenerateThings>c__Iterator15F();
			<GenerateThings>c__Iterator15F.<>f__this = this;
			StockGenerator_Category.<GenerateThings>c__Iterator15F expr_0E = <GenerateThings>c__Iterator15F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
