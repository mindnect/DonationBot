...
namespace RimWorld
{
	public class SlotGroup
	{
		...
		public IEnumerable<Thing> HeldThings
		{
			get
			{
				SlotGroup.<>c__Iterator132 <>c__Iterator = new SlotGroup.<>c__Iterator132();
				<>c__Iterator.<>f__this = this;
				SlotGroup.<>c__Iterator132 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			SlotGroup.<GetEnumerator>c__Iterator133 <GetEnumerator>c__Iterator = new SlotGroup.<GetEnumerator>c__Iterator133();
