...
namespace RimWorld
{
	public class Tale_SinglePawnAndThing : Tale_SinglePawn
	{
		...
		{
			Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11D <SpecialTextGenerationRules>c__Iterator11D = new Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11D();
			<SpecialTextGenerationRules>c__Iterator11D.<>f__this = this;
			Tale_SinglePawnAndThing.<SpecialTextGenerationRules>c__Iterator11D expr_0E = <SpecialTextGenerationRules>c__Iterator11D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
