...
namespace RimWorld
{
	public class NeedDef : Def
	{
		...
		{
			NeedDef.<ConfigErrors>c__Iterator8C <ConfigErrors>c__Iterator8C = new NeedDef.<ConfigErrors>c__Iterator8C();
			<ConfigErrors>c__Iterator8C.<>f__this = this;
			NeedDef.<ConfigErrors>c__Iterator8C expr_0E = <ConfigErrors>c__Iterator8C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
