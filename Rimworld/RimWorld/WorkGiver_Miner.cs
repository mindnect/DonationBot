...
namespace RimWorld
{
	public class WorkGiver_Miner : WorkGiver_Scanner
	{
		...
		{
			WorkGiver_Miner.<PotentialWorkThingsGlobal>c__Iterator60 <PotentialWorkThingsGlobal>c__Iterator = new WorkGiver_Miner.<PotentialWorkThingsGlobal>c__Iterator60();
			<PotentialWorkThingsGlobal>c__Iterator.pawn = pawn;
			<PotentialWorkThingsGlobal>c__Iterator.<$>pawn = pawn;
			WorkGiver_Miner.<PotentialWorkThingsGlobal>c__Iterator60 expr_15 = <PotentialWorkThingsGlobal>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
