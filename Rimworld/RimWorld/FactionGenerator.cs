...
namespace RimWorld
{
	public static class FactionGenerator
	{
		...
		{
			FactionGenerator.<EnsureRequiredEnemies>c__AnonStorey307 <EnsureRequiredEnemies>c__AnonStorey = new FactionGenerator.<EnsureRequiredEnemies>c__AnonStorey307();
