...
namespace RimWorld
{
	public abstract class CompPower : ThingComp
	{
		...
		{
			CompPower.<CompGetGizmosExtra>c__IteratorAA <CompGetGizmosExtra>c__IteratorAA = new CompPower.<CompGetGizmosExtra>c__IteratorAA();
			<CompGetGizmosExtra>c__IteratorAA.<>f__this = this;
			CompPower.<CompGetGizmosExtra>c__IteratorAA expr_0E = <CompGetGizmosExtra>c__IteratorAA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
