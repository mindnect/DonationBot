...
namespace RimWorld
{
	public class Backstory
	{
		...
		public IEnumerable<WorkTypeDef> DisabledWorkTypes
		{
			get
			{
				Backstory.<>c__IteratorD6 <>c__IteratorD = new Backstory.<>c__IteratorD6();
				<>c__IteratorD.<>f__this = this;
				Backstory.<>c__IteratorD6 expr_0E = <>c__IteratorD;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Backstory.<ConfigErrors>c__IteratorD7 <ConfigErrors>c__IteratorD = new Backstory.<ConfigErrors>c__IteratorD7();
			<ConfigErrors>c__IteratorD.ignoreNoSpawnCategories = ignoreNoSpawnCategories;
			<ConfigErrors>c__IteratorD.<$>ignoreNoSpawnCategories = ignoreNoSpawnCategories;
			<ConfigErrors>c__IteratorD.<>f__this = this;
			Backstory.<ConfigErrors>c__IteratorD7 expr_1C = <ConfigErrors>c__IteratorD;
			expr_1C.$PC = -2;
			return expr_1C;
		}
