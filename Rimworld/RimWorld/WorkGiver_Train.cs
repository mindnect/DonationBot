...
namespace RimWorld
{
	public class WorkGiver_Train : WorkGiver_InteractAnimal
	{
		...
		{
			WorkGiver_Train.<PotentialWorkThingsGlobal>c__Iterator5B <PotentialWorkThingsGlobal>c__Iterator5B = new WorkGiver_Train.<PotentialWorkThingsGlobal>c__Iterator5B();
			<PotentialWorkThingsGlobal>c__Iterator5B.pawn = pawn;
			<PotentialWorkThingsGlobal>c__Iterator5B.<$>pawn = pawn;
			WorkGiver_Train.<PotentialWorkThingsGlobal>c__Iterator5B expr_15 = <PotentialWorkThingsGlobal>c__Iterator5B;
			expr_15.$PC = -2;
			return expr_15;
		}
