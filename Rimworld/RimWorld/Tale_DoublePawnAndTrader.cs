...
namespace RimWorld
{
	public class Tale_DoublePawnAndTrader : Tale_DoublePawn
	{
		...
		{
			Tale_DoublePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11A <SpecialTextGenerationRules>c__Iterator11A = new Tale_DoublePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11A();
			<SpecialTextGenerationRules>c__Iterator11A.<>f__this = this;
			Tale_DoublePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11A expr_0E = <SpecialTextGenerationRules>c__Iterator11A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
