...
namespace RimWorld
{
	public class IncidentQueue : IExposable
	{
		...
		{
			IncidentQueue.<GetEnumerator>c__Iterator9B <GetEnumerator>c__Iterator9B = new IncidentQueue.<GetEnumerator>c__Iterator9B();
			<GetEnumerator>c__Iterator9B.<>f__this = this;
			return <GetEnumerator>c__Iterator9B;
		}
