...
namespace RimWorld
{
	public static class ScenarioLister
	{
		...
		{
			ScenarioLister.<AllScenarios>c__Iterator10D <AllScenarios>c__Iterator10D = new ScenarioLister.<AllScenarios>c__Iterator10D();
			ScenarioLister.<AllScenarios>c__Iterator10D expr_07 = <AllScenarios>c__Iterator10D;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			ScenarioLister.<ScenariosInCategory>c__Iterator10E <ScenariosInCategory>c__Iterator10E = new ScenarioLister.<ScenariosInCategory>c__Iterator10E();
			<ScenariosInCategory>c__Iterator10E.cat = cat;
			<ScenariosInCategory>c__Iterator10E.<$>cat = cat;
			ScenarioLister.<ScenariosInCategory>c__Iterator10E expr_15 = <ScenariosInCategory>c__Iterator10E;
			expr_15.$PC = -2;
			return expr_15;
		}
