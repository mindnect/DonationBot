...
namespace RimWorld
{
	public sealed class ThoughtHandler : IExposable
	{
		...
		{
			ThoughtHandler.<ThoughtsInGroup>c__IteratorE5 <ThoughtsInGroup>c__IteratorE = new ThoughtHandler.<ThoughtsInGroup>c__IteratorE5();
			<ThoughtsInGroup>c__IteratorE.group = group;
			<ThoughtsInGroup>c__IteratorE.<$>group = group;
			<ThoughtsInGroup>c__IteratorE.<>f__this = this;
			ThoughtHandler.<ThoughtsInGroup>c__IteratorE5 expr_1C = <ThoughtsInGroup>c__IteratorE;
			expr_1C.$PC = -2;
			return expr_1C;
		}
