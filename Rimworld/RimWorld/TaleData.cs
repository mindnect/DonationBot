...
namespace RimWorld
{
	public abstract class TaleData : IExposable
	{
		...
		{
			TaleData.<GetRules>c__Iterator111 <GetRules>c__Iterator = new TaleData.<GetRules>c__Iterator111();
			<GetRules>c__Iterator.<>f__this = this;
			TaleData.<GetRules>c__Iterator111 expr_0E = <GetRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
