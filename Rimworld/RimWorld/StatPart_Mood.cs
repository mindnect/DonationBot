...
namespace RimWorld
{
	public class StatPart_Mood : StatPart
	{
		...
		{
			StatPart_Mood.<ConfigErrors>c__Iterator18D <ConfigErrors>c__Iterator18D = new StatPart_Mood.<ConfigErrors>c__Iterator18D();
			<ConfigErrors>c__Iterator18D.<>f__this = this;
			StatPart_Mood.<ConfigErrors>c__Iterator18D expr_0E = <ConfigErrors>c__Iterator18D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
