...
namespace RimWorld
{
	public static class ShipUtility
	{
		...
		{
			ShipUtility.<LaunchFailReasons>c__Iterator156 <LaunchFailReasons>c__Iterator = new ShipUtility.<LaunchFailReasons>c__Iterator156();
			<LaunchFailReasons>c__Iterator.rootBuilding = rootBuilding;
			<LaunchFailReasons>c__Iterator.<$>rootBuilding = rootBuilding;
			ShipUtility.<LaunchFailReasons>c__Iterator156 expr_15 = <LaunchFailReasons>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
