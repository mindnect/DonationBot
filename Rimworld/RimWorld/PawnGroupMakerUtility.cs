...
namespace RimWorld
{
	public class PawnGroupMakerUtility
	{
		...
		{
			PawnGroupMakerUtility.<GeneratePawns>c__IteratorC4 <GeneratePawns>c__IteratorC = new PawnGroupMakerUtility.<GeneratePawns>c__IteratorC4();
			...
			<GeneratePawns>c__IteratorC.<$>parms = parms;
			<GeneratePawns>c__IteratorC.<$>warnOnZeroResults = warnOnZeroResults;
			PawnGroupMakerUtility.<GeneratePawns>c__IteratorC4 expr_31 = <GeneratePawns>c__IteratorC;
			expr_31.$PC = -2;
			return expr_31;
		}
