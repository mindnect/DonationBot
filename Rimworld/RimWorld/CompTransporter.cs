...
namespace RimWorld
{
	...
	public class CompTransporter : ThingComp, IThingContainerOwner
	{
		...
		{
			CompTransporter.<CompGetGizmosExtra>c__Iterator154 <CompGetGizmosExtra>c__Iterator = new CompTransporter.<CompGetGizmosExtra>c__Iterator154();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompTransporter.<CompGetGizmosExtra>c__Iterator154 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
