...
namespace RimWorld
{
	public static class TraderStockGenerator
	{
		...
		{
			TraderStockGenerator.<GenerateTraderThings>c__Iterator164 <GenerateTraderThings>c__Iterator = new TraderStockGenerator.<GenerateTraderThings>c__Iterator164();
			<GenerateTraderThings>c__Iterator.traderDef = traderDef;
			<GenerateTraderThings>c__Iterator.forMap = forMap;
			<GenerateTraderThings>c__Iterator.<$>traderDef = traderDef;
			<GenerateTraderThings>c__Iterator.<$>forMap = forMap;
			TraderStockGenerator.<GenerateTraderThings>c__Iterator164 expr_23 = <GenerateTraderThings>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
