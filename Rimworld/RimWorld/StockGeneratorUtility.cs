...
namespace RimWorld
{
	public class StockGeneratorUtility
	{
		...
		{
			StockGeneratorUtility.<TryMakeForStock>c__Iterator15A <TryMakeForStock>c__Iterator15A = new StockGeneratorUtility.<TryMakeForStock>c__Iterator15A();
			<TryMakeForStock>c__Iterator15A.thingDef = thingDef;
			<TryMakeForStock>c__Iterator15A.count = count;
			<TryMakeForStock>c__Iterator15A.<$>thingDef = thingDef;
			<TryMakeForStock>c__Iterator15A.<$>count = count;
			StockGeneratorUtility.<TryMakeForStock>c__Iterator15A expr_23 = <TryMakeForStock>c__Iterator15A;
			expr_23.$PC = -2;
			return expr_23;
		}
