...
namespace RimWorld
{
	public class Instruction_AddBill : Lesson_Instruction
	{
		...
		{
			Instruction_AddBill.<ThingsToSelect>c__Iterator183 <ThingsToSelect>c__Iterator = new Instruction_AddBill.<ThingsToSelect>c__Iterator183();
			<ThingsToSelect>c__Iterator.<>f__this = this;
			Instruction_AddBill.<ThingsToSelect>c__Iterator183 expr_0E = <ThingsToSelect>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
