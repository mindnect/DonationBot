...
namespace RimWorld
{
	public class TradeShip : PassingShip, ITrader
	{
		...
		{
			TradeShip.<ColonyThingsWillingToBuy>c__Iterator165 <ColonyThingsWillingToBuy>c__Iterator = new TradeShip.<ColonyThingsWillingToBuy>c__Iterator165();
			<ColonyThingsWillingToBuy>c__Iterator.<>f__this = this;
			TradeShip.<ColonyThingsWillingToBuy>c__Iterator165 expr_0E = <ColonyThingsWillingToBuy>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
