...
namespace RimWorld
{
	public class StockGenerator_Slaves : StockGenerator
	{
		...
		{
			StockGenerator_Slaves.<GenerateThings>c__Iterator161 <GenerateThings>c__Iterator = new StockGenerator_Slaves.<GenerateThings>c__Iterator161();
			<GenerateThings>c__Iterator.forMap = forMap;
			<GenerateThings>c__Iterator.<$>forMap = forMap;
			<GenerateThings>c__Iterator.<>f__this = this;
			StockGenerator_Slaves.<GenerateThings>c__Iterator161 expr_1C = <GenerateThings>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
