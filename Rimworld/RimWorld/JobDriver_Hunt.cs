...
namespace RimWorld
{
	public class JobDriver_Hunt : JobDriver
	{
		...
		{
			JobDriver_Hunt.<MakeNewToils>c__Iterator2D <MakeNewToils>c__Iterator2D = new JobDriver_Hunt.<MakeNewToils>c__Iterator2D();
			<MakeNewToils>c__Iterator2D.<>f__this = this;
			JobDriver_Hunt.<MakeNewToils>c__Iterator2D expr_0E = <MakeNewToils>c__Iterator2D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
