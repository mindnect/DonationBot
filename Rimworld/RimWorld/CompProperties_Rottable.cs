...
namespace RimWorld
{
	public class CompProperties_Rottable : CompProperties
	{
		...
		{
			CompProperties_Rottable.<ConfigErrors>c__Iterator7A <ConfigErrors>c__Iterator7A = new CompProperties_Rottable.<ConfigErrors>c__Iterator7A();
			<ConfigErrors>c__Iterator7A.parentDef = parentDef;
			<ConfigErrors>c__Iterator7A.<$>parentDef = parentDef;
			<ConfigErrors>c__Iterator7A.<>f__this = this;
			CompProperties_Rottable.<ConfigErrors>c__Iterator7A expr_1C = <ConfigErrors>c__Iterator7A;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
