...
namespace RimWorld
{
	public class TraitDef : Def
	{
		...
		{
			TraitDef.<ConfigErrors>c__Iterator97 <ConfigErrors>c__Iterator = new TraitDef.<ConfigErrors>c__Iterator97();
			<ConfigErrors>c__Iterator.<>f__this = this;
			TraitDef.<ConfigErrors>c__Iterator97 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
