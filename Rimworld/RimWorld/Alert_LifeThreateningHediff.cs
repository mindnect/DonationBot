...
namespace RimWorld
{
	public class Alert_LifeThreateningHediff : Alert_Critical
	{
		private IEnumerable<Pawn> SickPawns
		{
			get
			{
				Alert_LifeThreateningHediff.<>c__Iterator16A <>c__Iterator16A = new Alert_LifeThreateningHediff.<>c__Iterator16A();
				Alert_LifeThreateningHediff.<>c__Iterator16A expr_07 = <>c__Iterator16A;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
