...
namespace RimWorld
{
	public static class Autotests_RandomNumbers
	{
		...
		{
			Autotests_RandomNumbers.<RandomFloats>c__Iterator187 <RandomFloats>c__Iterator = new Autotests_RandomNumbers.<RandomFloats>c__Iterator187();
			<RandomFloats>c__Iterator.count = count;
			<RandomFloats>c__Iterator.<$>count = count;
			Autotests_RandomNumbers.<RandomFloats>c__Iterator187 expr_15 = <RandomFloats>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
