...
namespace RimWorld
{
	public class Designator_Open : Designator
	{
		...
		{
			Designator_Open.<OpenablesInCell>c__Iterator173 <OpenablesInCell>c__Iterator = new Designator_Open.<OpenablesInCell>c__Iterator173();
			<OpenablesInCell>c__Iterator.c = c;
			<OpenablesInCell>c__Iterator.<$>c = c;
			<OpenablesInCell>c__Iterator.<>f__this = this;
			Designator_Open.<OpenablesInCell>c__Iterator173 expr_1C = <OpenablesInCell>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
