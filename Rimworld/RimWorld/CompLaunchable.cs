...
namespace RimWorld
{
	...
	public class CompLaunchable : ThingComp
	{
		...
		{
			CompLaunchable.<CompGetGizmosExtra>c__Iterator14C <CompGetGizmosExtra>c__Iterator14C = new CompLaunchable.<CompGetGizmosExtra>c__Iterator14C();
			<CompGetGizmosExtra>c__Iterator14C.<>f__this = this;
			CompLaunchable.<CompGetGizmosExtra>c__Iterator14C expr_0E = <CompGetGizmosExtra>c__Iterator14C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
