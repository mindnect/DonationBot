...
namespace RimWorld
{
	public class Tale_DoublePawnAndDef : Tale_DoublePawn
	{
		...
		{
			Tale_DoublePawnAndDef.<SpecialTextGenerationRules>c__Iterator119 <SpecialTextGenerationRules>c__Iterator = new Tale_DoublePawnAndDef.<SpecialTextGenerationRules>c__Iterator119();
			<SpecialTextGenerationRules>c__Iterator.<>f__this = this;
			Tale_DoublePawnAndDef.<SpecialTextGenerationRules>c__Iterator119 expr_0E = <SpecialTextGenerationRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
