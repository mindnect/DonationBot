...
namespace RimWorld
{
	public class Pawn_ApparelTracker : IExposable
	{
		...
		public IEnumerable<Apparel> WornApparelInDrawOrder
		{
			get
			{
				Pawn_ApparelTracker.<>c__IteratorDD <>c__IteratorDD = new Pawn_ApparelTracker.<>c__IteratorDD();
				<>c__IteratorDD.<>f__this = this;
				Pawn_ApparelTracker.<>c__IteratorDD expr_0E = <>c__IteratorDD;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Pawn_ApparelTracker.<GetGizmos>c__IteratorDE <GetGizmos>c__IteratorDE = new Pawn_ApparelTracker.<GetGizmos>c__IteratorDE();
			<GetGizmos>c__IteratorDE.<>f__this = this;
			Pawn_ApparelTracker.<GetGizmos>c__IteratorDE expr_0E = <GetGizmos>c__IteratorDE;
			expr_0E.$PC = -2;
			return expr_0E;
		}
