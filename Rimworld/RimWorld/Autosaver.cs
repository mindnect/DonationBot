...
namespace RimWorld
{
	public sealed class Autosaver
	{
		...
		{
			Autosaver.<AutoSaveNames>c__Iterator186 <AutoSaveNames>c__Iterator = new Autosaver.<AutoSaveNames>c__Iterator186();
			Autosaver.<AutoSaveNames>c__Iterator186 expr_07 = <AutoSaveNames>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
