...
namespace RimWorld
{
	public class Building_TrapRearmable : Building_Trap
	{
		...
		{
			Building_TrapRearmable.<GetGizmos>c__Iterator12D <GetGizmos>c__Iterator12D = new Building_TrapRearmable.<GetGizmos>c__Iterator12D();
			<GetGizmos>c__Iterator12D.<>f__this = this;
			Building_TrapRearmable.<GetGizmos>c__Iterator12D expr_0E = <GetGizmos>c__Iterator12D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
