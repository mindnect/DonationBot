...
namespace RimWorld
{
	public class Pawn_StoryTracker : IExposable
	{
		...
		public IEnumerable<Backstory> AllBackstories
		{
			get
			{
				Pawn_StoryTracker.<>c__IteratorD8 <>c__IteratorD = new Pawn_StoryTracker.<>c__IteratorD8();
				<>c__IteratorD.<>f__this = this;
				Pawn_StoryTracker.<>c__IteratorD8 expr_0E = <>c__IteratorD;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		public IEnumerable<WorkTags> DisabledWorkTags
		{
			get
			{
				Pawn_StoryTracker.<>c__IteratorD9 <>c__IteratorD = new Pawn_StoryTracker.<>c__IteratorD9();
				<>c__IteratorD.<>f__this = this;
				Pawn_StoryTracker.<>c__IteratorD9 expr_0E = <>c__IteratorD;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
