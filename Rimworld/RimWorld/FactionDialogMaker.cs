...
namespace RimWorld
{
	public static class FactionDialogMaker
	{
		...
		{
			FactionDialogMaker.<DebugOptions>c__IteratorE9 <DebugOptions>c__IteratorE = new FactionDialogMaker.<DebugOptions>c__IteratorE9();
			FactionDialogMaker.<DebugOptions>c__IteratorE9 expr_07 = <DebugOptions>c__IteratorE;
			expr_07.$PC = -2;
			return expr_07;
		}
