...
namespace RimWorld
{
	public static class StatsReportUtility
	{
		...
		private static IEnumerable<StatDrawEntry> StatsToDraw(Def def, ThingDef stuff)
		{
			...
			<StatsToDraw>c__Iterator17B.def = def;
			<StatsToDraw>c__Iterator17B.stuff = stuff;
			<StatsToDraw>c__Iterator17B.<$>def = def;
			<StatsToDraw>c__Iterator17B.<$>stuff = stuff;
			StatsReportUtility.<StatsToDraw>c__Iterator17B expr_23 = <StatsToDraw>c__Iterator17B;
			expr_23.$PC = -2;
			return expr_23;
		}
		...
		{
			StatsReportUtility.<StatsToDraw>c__Iterator17C <StatsToDraw>c__Iterator17C = new StatsReportUtility.<StatsToDraw>c__Iterator17C();
			<StatsToDraw>c__Iterator17C.thing = thing;
			<StatsToDraw>c__Iterator17C.<$>thing = thing;
			StatsReportUtility.<StatsToDraw>c__Iterator17C expr_15 = <StatsToDraw>c__Iterator17C;
			expr_15.$PC = -2;
			return expr_15;
		}
