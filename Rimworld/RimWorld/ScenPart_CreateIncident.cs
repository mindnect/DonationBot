...
namespace RimWorld
{
	internal class ScenPart_CreateIncident : ScenPart_IncidentBase
	{
		...
		{
			ScenPart_CreateIncident.<RandomizableIncidents>c__Iterator100 <RandomizableIncidents>c__Iterator = new ScenPart_CreateIncident.<RandomizableIncidents>c__Iterator100();
			ScenPart_CreateIncident.<RandomizableIncidents>c__Iterator100 expr_07 = <RandomizableIncidents>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
