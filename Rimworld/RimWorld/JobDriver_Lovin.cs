...
namespace RimWorld
{
	public class JobDriver_Lovin : JobDriver
	{
		...
		{
			JobDriver_Lovin.<MakeNewToils>c__Iterator31 <MakeNewToils>c__Iterator = new JobDriver_Lovin.<MakeNewToils>c__Iterator31();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_Lovin.<MakeNewToils>c__Iterator31 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
