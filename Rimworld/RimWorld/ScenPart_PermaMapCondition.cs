...
namespace RimWorld
{
	public class ScenPart_PermaMapCondition : ScenPart
	{
		...
		{
			ScenPart_PermaMapCondition.<GetSummaryListEntries>c__IteratorFB <GetSummaryListEntries>c__IteratorFB = new ScenPart_PermaMapCondition.<GetSummaryListEntries>c__IteratorFB();
			<GetSummaryListEntries>c__IteratorFB.tag = tag;
			<GetSummaryListEntries>c__IteratorFB.<$>tag = tag;
			<GetSummaryListEntries>c__IteratorFB.<>f__this = this;
			ScenPart_PermaMapCondition.<GetSummaryListEntries>c__IteratorFB expr_1C = <GetSummaryListEntries>c__IteratorFB;
			expr_1C.$PC = -2;
			return expr_1C;
		}
