...
namespace RimWorld
{
	public static class SiegeBlueprintPlacer
	{
		...
		{
			SiegeBlueprintPlacer.<PlaceBlueprints>c__Iterator67 <PlaceBlueprints>c__Iterator = new SiegeBlueprintPlacer.<PlaceBlueprints>c__Iterator67();
			...
			<PlaceBlueprints>c__Iterator.<$>map = map;
			<PlaceBlueprints>c__Iterator.<$>points = points;
			SiegeBlueprintPlacer.<PlaceBlueprints>c__Iterator67 expr_3F = <PlaceBlueprints>c__Iterator;
			expr_3F.$PC = -2;
			return expr_3F;
		}
		...
		{
			SiegeBlueprintPlacer.<PlaceSandbagBlueprints>c__Iterator68 <PlaceSandbagBlueprints>c__Iterator = new SiegeBlueprintPlacer.<PlaceSandbagBlueprints>c__Iterator68();
			<PlaceSandbagBlueprints>c__Iterator.map = map;
			<PlaceSandbagBlueprints>c__Iterator.<$>map = map;
			SiegeBlueprintPlacer.<PlaceSandbagBlueprints>c__Iterator68 expr_15 = <PlaceSandbagBlueprints>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			SiegeBlueprintPlacer.<MakeSandbagLine>c__Iterator69 <MakeSandbagLine>c__Iterator = new SiegeBlueprintPlacer.<MakeSandbagLine>c__Iterator69();
			...
			<MakeSandbagLine>c__Iterator.<$>map = map;
			<MakeSandbagLine>c__Iterator.<$>growDir = growDir;
			SiegeBlueprintPlacer.<MakeSandbagLine>c__Iterator69 expr_3F = <MakeSandbagLine>c__Iterator;
			expr_3F.$PC = -2;
			return expr_3F;
		}
		...
		{
			SiegeBlueprintPlacer.<PlaceArtilleryBlueprints>c__Iterator6A <PlaceArtilleryBlueprints>c__Iterator6A = new SiegeBlueprintPlacer.<PlaceArtilleryBlueprints>c__Iterator6A();
			<PlaceArtilleryBlueprints>c__Iterator6A.points = points;
			<PlaceArtilleryBlueprints>c__Iterator6A.map = map;
			<PlaceArtilleryBlueprints>c__Iterator6A.<$>points = points;
			<PlaceArtilleryBlueprints>c__Iterator6A.<$>map = map;
			SiegeBlueprintPlacer.<PlaceArtilleryBlueprints>c__Iterator6A expr_23 = <PlaceArtilleryBlueprints>c__Iterator6A;
			expr_23.$PC = -2;
			return expr_23;
		}
