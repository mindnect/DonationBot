...
namespace RimWorld
{
	public static class ThingSelectionUtility
	{
		...
		{
			ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator17F <MultiSelectableThingsInScreenRectDistinct>c__Iterator17F = new ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator17F();
			<MultiSelectableThingsInScreenRectDistinct>c__Iterator17F.rect = rect;
			<MultiSelectableThingsInScreenRectDistinct>c__Iterator17F.<$>rect = rect;
			ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator17F expr_15 = <MultiSelectableThingsInScreenRectDistinct>c__Iterator17F;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator180 <MultiSelectableZonesInScreenRectDistinct>c__Iterator = new ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator180();
			<MultiSelectableZonesInScreenRectDistinct>c__Iterator.rect = rect;
			<MultiSelectableZonesInScreenRectDistinct>c__Iterator.<$>rect = rect;
			ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator180 expr_15 = <MultiSelectableZonesInScreenRectDistinct>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
