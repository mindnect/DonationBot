...
namespace RimWorld
{
	public class Verb_MeleeAttack : Verb
	{
		...
		{
			Verb_MeleeAttack.<DamageInfosToApply>c__Iterator18F <DamageInfosToApply>c__Iterator18F = new Verb_MeleeAttack.<DamageInfosToApply>c__Iterator18F();
			<DamageInfosToApply>c__Iterator18F.target = target;
			<DamageInfosToApply>c__Iterator18F.<$>target = target;
			<DamageInfosToApply>c__Iterator18F.<>f__this = this;
			Verb_MeleeAttack.<DamageInfosToApply>c__Iterator18F expr_1C = <DamageInfosToApply>c__Iterator18F;
			expr_1C.$PC = -2;
			return expr_1C;
		}
