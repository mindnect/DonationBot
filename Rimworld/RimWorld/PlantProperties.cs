...
namespace RimWorld
{
	public class PlantProperties
	{
		...
		{
			PlantProperties.<ConfigErrors>c__Iterator80 <ConfigErrors>c__Iterator = new PlantProperties.<ConfigErrors>c__Iterator80();
			<ConfigErrors>c__Iterator.<>f__this = this;
			PlantProperties.<ConfigErrors>c__Iterator80 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			PlantProperties.<SpecialDisplayStats>c__Iterator81 <SpecialDisplayStats>c__Iterator = new PlantProperties.<SpecialDisplayStats>c__Iterator81();
			<SpecialDisplayStats>c__Iterator.<>f__this = this;
			PlantProperties.<SpecialDisplayStats>c__Iterator81 expr_0E = <SpecialDisplayStats>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
