...
namespace RimWorld
{
	...
	public class CompRefuelable : ThingComp
	{
		...
		{
			CompRefuelable.<CompGetGizmosExtra>c__Iterator14F <CompGetGizmosExtra>c__Iterator14F = new CompRefuelable.<CompGetGizmosExtra>c__Iterator14F();
			<CompGetGizmosExtra>c__Iterator14F.<>f__this = this;
			CompRefuelable.<CompGetGizmosExtra>c__Iterator14F expr_0E = <CompGetGizmosExtra>c__Iterator14F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
