...
namespace RimWorld
{
	public class InstructionDef : Def
	{
		...
		{
			InstructionDef.<ConfigErrors>c__Iterator99 <ConfigErrors>c__Iterator = new InstructionDef.<ConfigErrors>c__Iterator99();
			<ConfigErrors>c__Iterator.<>f__this = this;
			InstructionDef.<ConfigErrors>c__Iterator99 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
