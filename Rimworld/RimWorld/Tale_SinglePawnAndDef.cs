...
namespace RimWorld
{
	public class Tale_SinglePawnAndDef : Tale_SinglePawn
	{
		...
		{
			Tale_SinglePawnAndDef.<SpecialTextGenerationRules>c__Iterator11C <SpecialTextGenerationRules>c__Iterator11C = new Tale_SinglePawnAndDef.<SpecialTextGenerationRules>c__Iterator11C();
			<SpecialTextGenerationRules>c__Iterator11C.<>f__this = this;
			Tale_SinglePawnAndDef.<SpecialTextGenerationRules>c__Iterator11C expr_0E = <SpecialTextGenerationRules>c__Iterator11C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
