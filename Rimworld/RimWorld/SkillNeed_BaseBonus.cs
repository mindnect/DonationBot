...
namespace RimWorld
{
	public class SkillNeed_BaseBonus : SkillNeed
	{
		...
		{
			SkillNeed_BaseBonus.<ConfigErrors>c__Iterator83 <ConfigErrors>c__Iterator = new SkillNeed_BaseBonus.<ConfigErrors>c__Iterator83();
			<ConfigErrors>c__Iterator.<>f__this = this;
			SkillNeed_BaseBonus.<ConfigErrors>c__Iterator83 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
