...
namespace RimWorld
{
	public class Tale_SinglePawnAndTrader : Tale_SinglePawn
	{
		...
		{
			Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11E <SpecialTextGenerationRules>c__Iterator11E = new Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11E();
			<SpecialTextGenerationRules>c__Iterator11E.<>f__this = this;
			Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator11E expr_0E = <SpecialTextGenerationRules>c__Iterator11E;
			expr_0E.$PC = -2;
			return expr_0E;
		}
