...
namespace RimWorld
{
	public class Scenario : IExposable, WorkshopUploadable
	{
		...
		public IEnumerable<ScenPart> AllParts
		{
			get
			{
				Scenario.<>c__Iterator10B <>c__Iterator10B = new Scenario.<>c__Iterator10B();
				<>c__Iterator10B.<>f__this = this;
				Scenario.<>c__Iterator10B expr_0E = <>c__Iterator10B;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Scenario.<ConfigErrors>c__Iterator10C <ConfigErrors>c__Iterator10C = new Scenario.<ConfigErrors>c__Iterator10C();
			<ConfigErrors>c__Iterator10C.<>f__this = this;
			Scenario.<ConfigErrors>c__Iterator10C expr_0E = <ConfigErrors>c__Iterator10C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
