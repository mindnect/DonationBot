...
namespace RimWorld
{
	public class ConceptDef : Def
	{
		...
		{
			ConceptDef.<ConfigErrors>c__Iterator98 <ConfigErrors>c__Iterator = new ConceptDef.<ConfigErrors>c__Iterator98();
			<ConfigErrors>c__Iterator.<>f__this = this;
			ConceptDef.<ConfigErrors>c__Iterator98 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
