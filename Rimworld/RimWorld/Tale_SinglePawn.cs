...
namespace RimWorld
{
	public class Tale_SinglePawn : Tale
	{
		...
		{
			Tale_SinglePawn.<SpecialTextGenerationRules>c__Iterator11B <SpecialTextGenerationRules>c__Iterator11B = new Tale_SinglePawn.<SpecialTextGenerationRules>c__Iterator11B();
			<SpecialTextGenerationRules>c__Iterator11B.<>f__this = this;
			Tale_SinglePawn.<SpecialTextGenerationRules>c__Iterator11B expr_0E = <SpecialTextGenerationRules>c__Iterator11B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
