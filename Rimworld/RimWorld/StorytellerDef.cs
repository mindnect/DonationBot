...
namespace RimWorld
{
	public class StorytellerDef : Def
	{
		...
		{
			StorytellerDef.<ConfigErrors>c__Iterator91 <ConfigErrors>c__Iterator = new StorytellerDef.<ConfigErrors>c__Iterator91();
			<ConfigErrors>c__Iterator.<>f__this = this;
			StorytellerDef.<ConfigErrors>c__Iterator91 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
