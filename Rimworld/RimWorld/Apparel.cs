...
namespace RimWorld
{
	public class Apparel : ThingWithComps
	{
		...
		{
			Apparel.<GetWornGizmos>c__Iterator145 <GetWornGizmos>c__Iterator = new Apparel.<GetWornGizmos>c__Iterator145();
			Apparel.<GetWornGizmos>c__Iterator145 expr_07 = <GetWornGizmos>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
