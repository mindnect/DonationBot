...
namespace RimWorld
{
	...
	public class Building_FermentingBarrel : Building
	{
		...
		{
			Building_FermentingBarrel.<GetGizmos>c__Iterator13D <GetGizmos>c__Iterator13D = new Building_FermentingBarrel.<GetGizmos>c__Iterator13D();
			<GetGizmos>c__Iterator13D.<>f__this = this;
			Building_FermentingBarrel.<GetGizmos>c__Iterator13D expr_0E = <GetGizmos>c__Iterator13D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
