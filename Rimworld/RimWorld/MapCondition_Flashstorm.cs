...
namespace RimWorld
{
	public class MapCondition_Flashstorm : MapCondition
	{
		...
		{
			MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__Iterator9C <GetPotentiallyAffectedCells>c__Iterator9C = new MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__Iterator9C();
			<GetPotentiallyAffectedCells>c__Iterator9C.center = center;
			<GetPotentiallyAffectedCells>c__Iterator9C.<$>center = center;
			<GetPotentiallyAffectedCells>c__Iterator9C.<>f__this = this;
			MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__Iterator9C expr_1C = <GetPotentiallyAffectedCells>c__Iterator9C;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
