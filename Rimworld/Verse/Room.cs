...
namespace Verse
{
	public sealed class Room
	{
		...
		public IEnumerable<Building_Bed> ContainedBeds
		{
			get
			{
				Room.<>c__Iterator1E2 <>c__Iterator1E = new Room.<>c__Iterator1E2();
				<>c__Iterator1E.<>f__this = this;
				Room.<>c__Iterator1E2 expr_0E = <>c__Iterator1E;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Room.<GetEnumerator>c__Iterator1E3 <GetEnumerator>c__Iterator1E = new Room.<GetEnumerator>c__Iterator1E3();
