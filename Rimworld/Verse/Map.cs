...
namespace Verse
{
	public sealed class Map : IIncidentTarget, ILoadReferenceable, IExposable
	{
		...
		public IEnumerable<IntVec3> AllCells
		{
			get
			{
				Map.<>c__Iterator1D9 <>c__Iterator1D = new Map.<>c__Iterator1D9();
				<>c__Iterator1D.<>f__this = this;
				Map.<>c__Iterator1D9 expr_0E = <>c__Iterator1D;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Map.<GetEnumerator>c__Iterator1DA <GetEnumerator>c__Iterator1DA = new Map.<GetEnumerator>c__Iterator1DA();
			<GetEnumerator>c__Iterator1DA.<>f__this = this;
			return <GetEnumerator>c__Iterator1DA;
		}
