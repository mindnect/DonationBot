...
namespace Verse
{
	public static class ContentFinder<T> where T : class
	{
		...
		{
			ContentFinder<T>.<GetAllInFolder>c__Iterator1E7 <GetAllInFolder>c__Iterator1E = new ContentFinder<T>.<GetAllInFolder>c__Iterator1E7();
			<GetAllInFolder>c__Iterator1E.folderPath = folderPath;
			<GetAllInFolder>c__Iterator1E.<$>folderPath = folderPath;
			ContentFinder<T>.<GetAllInFolder>c__Iterator1E7 expr_15 = <GetAllInFolder>c__Iterator1E;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
