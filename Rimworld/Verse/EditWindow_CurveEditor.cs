...
namespace Verse
{
	public class EditWindow_CurveEditor : EditWindow
	{
		...
		{
			EditWindow_CurveEditor.<PointsNearMouse>c__Iterator204 <PointsNearMouse>c__Iterator = new EditWindow_CurveEditor.<PointsNearMouse>c__Iterator204();
			<PointsNearMouse>c__Iterator.screenRect = screenRect;
			<PointsNearMouse>c__Iterator.<$>screenRect = screenRect;
			<PointsNearMouse>c__Iterator.<>f__this = this;
			EditWindow_CurveEditor.<PointsNearMouse>c__Iterator204 expr_1C = <PointsNearMouse>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
