...
namespace Verse
{
	public static class GenFile
	{
		...
		{
			GenFile.<LinesFromFile>c__Iterator21A <LinesFromFile>c__Iterator21A = new GenFile.<LinesFromFile>c__Iterator21A();
			<LinesFromFile>c__Iterator21A.filePath = filePath;
			<LinesFromFile>c__Iterator21A.<$>filePath = filePath;
			GenFile.<LinesFromFile>c__Iterator21A expr_15 = <LinesFromFile>c__Iterator21A;
			expr_15.$PC = -2;
			return expr_15;
		}
