...
namespace Verse
{
	public class ResearchProjectDef : Def
	{
		...
		{
			ResearchProjectDef.<ConfigErrors>c__Iterator1B5 <ConfigErrors>c__Iterator1B = new ResearchProjectDef.<ConfigErrors>c__Iterator1B5();
			<ConfigErrors>c__Iterator1B.<>f__this = this;
			ResearchProjectDef.<ConfigErrors>c__Iterator1B5 expr_0E = <ConfigErrors>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		public bool CanBeResearchedAt(Building_ResearchBench bench, bool ignoreResearchBenchPowerStatus)
		{
			...
			{
				ResearchProjectDef.<CanBeResearchedAt>c__AnonStorey479 <CanBeResearchedAt>c__AnonStorey = new ResearchProjectDef.<CanBeResearchedAt>c__AnonStorey479();
