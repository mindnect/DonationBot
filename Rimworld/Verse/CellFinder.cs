...
namespace Verse
{
	public static class CellFinder
	{
		...
		{
			CellFinder.<GetAdjacentCells>c__Iterator20F <GetAdjacentCells>c__Iterator20F = new CellFinder.<GetAdjacentCells>c__Iterator20F();
			<GetAdjacentCells>c__Iterator20F.x = x;
			<GetAdjacentCells>c__Iterator20F.pawn = pawn;
			<GetAdjacentCells>c__Iterator20F.radius = radius;
			<GetAdjacentCells>c__Iterator20F.<$>x = x;
			<GetAdjacentCells>c__Iterator20F.<$>pawn = pawn;
			<GetAdjacentCells>c__Iterator20F.<$>radius = radius;
			CellFinder.<GetAdjacentCells>c__Iterator20F expr_31 = <GetAdjacentCells>c__Iterator20F;
			expr_31.$PC = -2;
			return expr_31;
		}
	}
