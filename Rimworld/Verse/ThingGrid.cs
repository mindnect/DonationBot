...
namespace Verse
{
	public sealed class ThingGrid
	{
		...
		{
			ThingGrid.<ThingsAt>c__Iterator1D3 <ThingsAt>c__Iterator1D = new ThingGrid.<ThingsAt>c__Iterator1D3();
			<ThingsAt>c__Iterator1D.c = c;
			<ThingsAt>c__Iterator1D.<$>c = c;
			<ThingsAt>c__Iterator1D.<>f__this = this;
			ThingGrid.<ThingsAt>c__Iterator1D3 expr_1C = <ThingsAt>c__Iterator1D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
