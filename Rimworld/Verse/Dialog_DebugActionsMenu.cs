...
namespace Verse
{
	public class Dialog_DebugActionsMenu : Dialog_DebugOptionLister
	{
		...
		{
			Dialog_DebugActionsMenu.<PointsOptions>c__Iterator203 <PointsOptions>c__Iterator = new Dialog_DebugActionsMenu.<PointsOptions>c__Iterator203();
			Dialog_DebugActionsMenu.<PointsOptions>c__Iterator203 expr_07 = <PointsOptions>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
