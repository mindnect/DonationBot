...
namespace Verse
{
	public class DefInjectionPackage
	{
		...
		{
			DefInjectionPackage.<MissingInjections>c__Iterator1CB <MissingInjections>c__Iterator1CB = new DefInjectionPackage.<MissingInjections>c__Iterator1CB();
			<MissingInjections>c__Iterator1CB.<>f__this = this;
			DefInjectionPackage.<MissingInjections>c__Iterator1CB expr_0E = <MissingInjections>c__Iterator1CB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CC <MissingInjectionsFromDef>c__Iterator1CC = new DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CC();
			<MissingInjectionsFromDef>c__Iterator1CC.def = def;
			<MissingInjectionsFromDef>c__Iterator1CC.<$>def = def;
			<MissingInjectionsFromDef>c__Iterator1CC.<>f__this = this;
			DefInjectionPackage.<MissingInjectionsFromDef>c__Iterator1CC expr_1C = <MissingInjectionsFromDef>c__Iterator1CC;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
