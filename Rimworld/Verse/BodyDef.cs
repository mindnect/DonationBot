...
namespace Verse
{
	public class BodyDef : Def
	{
		...
		{
			BodyDef.<GetParts>c__Iterator1A0 <GetParts>c__Iterator1A = new BodyDef.<GetParts>c__Iterator1A0();
			<GetParts>c__Iterator1A.activity = activity;
			<GetParts>c__Iterator1A.activityGroup = activityGroup;
			<GetParts>c__Iterator1A.<$>activity = activity;
			<GetParts>c__Iterator1A.<$>activityGroup = activityGroup;
			<GetParts>c__Iterator1A.<>f__this = this;
			BodyDef.<GetParts>c__Iterator1A0 expr_2A = <GetParts>c__Iterator1A;
			expr_2A.$PC = -2;
			return expr_2A;
		}
		...
		{
			BodyDef.<ConfigErrors>c__Iterator1A1 <ConfigErrors>c__Iterator1A = new BodyDef.<ConfigErrors>c__Iterator1A1();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			BodyDef.<ConfigErrors>c__Iterator1A1 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
