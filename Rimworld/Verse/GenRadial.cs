...
namespace Verse
{
	public static class GenRadial
	{
		...
		{
			GenRadial.<RadialPatternInRadius>c__Iterator21B <RadialPatternInRadius>c__Iterator21B = new GenRadial.<RadialPatternInRadius>c__Iterator21B();
			<RadialPatternInRadius>c__Iterator21B.radius = radius;
			<RadialPatternInRadius>c__Iterator21B.<$>radius = radius;
			GenRadial.<RadialPatternInRadius>c__Iterator21B expr_15 = <RadialPatternInRadius>c__Iterator21B;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			GenRadial.<RadialCellsAround>c__Iterator21C <RadialCellsAround>c__Iterator21C = new GenRadial.<RadialCellsAround>c__Iterator21C();
			<RadialCellsAround>c__Iterator21C.radius = radius;
			<RadialCellsAround>c__Iterator21C.useCenter = useCenter;
			<RadialCellsAround>c__Iterator21C.center = center;
			<RadialCellsAround>c__Iterator21C.<$>radius = radius;
			<RadialCellsAround>c__Iterator21C.<$>useCenter = useCenter;
			<RadialCellsAround>c__Iterator21C.<$>center = center;
			GenRadial.<RadialCellsAround>c__Iterator21C expr_31 = <RadialCellsAround>c__Iterator21C;
			expr_31.$PC = -2;
			return expr_31;
		}
		...
		{
			GenRadial.<RadialDistinctThingsAround>c__Iterator21D <RadialDistinctThingsAround>c__Iterator21D = new GenRadial.<RadialDistinctThingsAround>c__Iterator21D();
			<RadialDistinctThingsAround>c__Iterator21D.radius = radius;
			<RadialDistinctThingsAround>c__Iterator21D.useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator21D.center = center;
			<RadialDistinctThingsAround>c__Iterator21D.map = map;
			<RadialDistinctThingsAround>c__Iterator21D.<$>radius = radius;
			<RadialDistinctThingsAround>c__Iterator21D.<$>useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator21D.<$>center = center;
			<RadialDistinctThingsAround>c__Iterator21D.<$>map = map;
			GenRadial.<RadialDistinctThingsAround>c__Iterator21D expr_3F = <RadialDistinctThingsAround>c__Iterator21D;
			expr_3F.$PC = -2;
			return expr_3F;
		}
	}
