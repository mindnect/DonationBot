...
namespace Verse
{
	public class PriorityWork : IExposable
	{
		...
		{
			PriorityWork.<GetGizmos>c__Iterator19E <GetGizmos>c__Iterator19E = new PriorityWork.<GetGizmos>c__Iterator19E();
			<GetGizmos>c__Iterator19E.pawn = pawn;
			<GetGizmos>c__Iterator19E.<$>pawn = pawn;
			<GetGizmos>c__Iterator19E.<>f__this = this;
			PriorityWork.<GetGizmos>c__Iterator19E expr_1C = <GetGizmos>c__Iterator19E;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
