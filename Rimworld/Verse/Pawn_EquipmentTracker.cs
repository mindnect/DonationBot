...
namespace Verse
{
	public class Pawn_EquipmentTracker : IExposable
	{
		...
		public IEnumerable<Verb> AllEquipmentVerbs
		{
			get
			{
				Pawn_EquipmentTracker.<>c__Iterator1FB <>c__Iterator1FB = new Pawn_EquipmentTracker.<>c__Iterator1FB();
				<>c__Iterator1FB.<>f__this = this;
				Pawn_EquipmentTracker.<>c__Iterator1FB expr_0E = <>c__Iterator1FB;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FC <GetGizmos>c__Iterator1FC = new Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FC();
			<GetGizmos>c__Iterator1FC.<>f__this = this;
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator1FC expr_0E = <GetGizmos>c__Iterator1FC;
			expr_0E.$PC = -2;
			return expr_0E;
		}
