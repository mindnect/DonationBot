...
namespace Verse
{
	public class MapConditionDef : Def
	{
		...
		{
			MapConditionDef.<ConfigErrors>c__Iterator1AE <ConfigErrors>c__Iterator1AE = new MapConditionDef.<ConfigErrors>c__Iterator1AE();
			<ConfigErrors>c__Iterator1AE.<>f__this = this;
			MapConditionDef.<ConfigErrors>c__Iterator1AE expr_0E = <ConfigErrors>c__Iterator1AE;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
