...
namespace Verse
{
	public static class GridSaveUtility
	{
		...
		{
			GridSaveUtility.<LoadedUShortGrid>c__Iterator1E4 <LoadedUShortGrid>c__Iterator1E = new GridSaveUtility.<LoadedUShortGrid>c__Iterator1E4();
			<LoadedUShortGrid>c__Iterator1E.compressedString = compressedString;
			<LoadedUShortGrid>c__Iterator1E.map = map;
			<LoadedUShortGrid>c__Iterator1E.<$>compressedString = compressedString;
			<LoadedUShortGrid>c__Iterator1E.<$>map = map;
			GridSaveUtility.<LoadedUShortGrid>c__Iterator1E4 expr_23 = <LoadedUShortGrid>c__Iterator1E;
			expr_23.$PC = -2;
			return expr_23;
		}
	}
