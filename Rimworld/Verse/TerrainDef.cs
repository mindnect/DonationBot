...
namespace Verse
{
	public class TerrainDef : BuildableDef
	{
		...
		{
			TerrainDef.<ConfigErrors>c__Iterator1BC <ConfigErrors>c__Iterator1BC = new TerrainDef.<ConfigErrors>c__Iterator1BC();
			<ConfigErrors>c__Iterator1BC.<>f__this = this;
			TerrainDef.<ConfigErrors>c__Iterator1BC expr_0E = <ConfigErrors>c__Iterator1BC;
			expr_0E.$PC = -2;
			return expr_0E;
		}
