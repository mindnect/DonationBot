...
namespace Verse
{
	public class WorkTypeDef : Def
	{
		...
		{
			WorkTypeDef.<ConfigErrors>c__Iterator1C7 <ConfigErrors>c__Iterator1C = new WorkTypeDef.<ConfigErrors>c__Iterator1C7();
			<ConfigErrors>c__Iterator1C.<>f__this = this;
			WorkTypeDef.<ConfigErrors>c__Iterator1C7 expr_0E = <ConfigErrors>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
