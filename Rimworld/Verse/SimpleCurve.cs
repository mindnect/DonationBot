...
namespace Verse
{
	public class SimpleCurve : IEnumerable, IEnumerable<CurvePoint>
	{
		...
		{
			SimpleCurve.<GetEnumerator>c__Iterator20D <GetEnumerator>c__Iterator20D = new SimpleCurve.<GetEnumerator>c__Iterator20D();
			<GetEnumerator>c__Iterator20D.<>f__this = this;
			return <GetEnumerator>c__Iterator20D;
		}
		...
		{
			SimpleCurve.<ConfigErrors>c__Iterator20E <ConfigErrors>c__Iterator20E = new SimpleCurve.<ConfigErrors>c__Iterator20E();
			<ConfigErrors>c__Iterator20E.prefix = prefix;
			<ConfigErrors>c__Iterator20E.<$>prefix = prefix;
			<ConfigErrors>c__Iterator20E.<>f__this = this;
			SimpleCurve.<ConfigErrors>c__Iterator20E expr_1C = <ConfigErrors>c__Iterator20E;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
