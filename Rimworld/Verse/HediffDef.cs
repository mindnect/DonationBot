...
namespace Verse
{
	public class HediffDef : Def
	{
		...
		{
			HediffDef.<ConfigErrors>c__Iterator1AA <ConfigErrors>c__Iterator1AA = new HediffDef.<ConfigErrors>c__Iterator1AA();
			<ConfigErrors>c__Iterator1AA.<>f__this = this;
			HediffDef.<ConfigErrors>c__Iterator1AA expr_0E = <ConfigErrors>c__Iterator1AA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			HediffDef.<SpecialDisplayStats>c__Iterator1AB <SpecialDisplayStats>c__Iterator1AB = new HediffDef.<SpecialDisplayStats>c__Iterator1AB();
			<SpecialDisplayStats>c__Iterator1AB.<>f__this = this;
			HediffDef.<SpecialDisplayStats>c__Iterator1AB expr_0E = <SpecialDisplayStats>c__Iterator1AB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
