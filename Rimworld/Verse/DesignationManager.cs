...
namespace Verse
{
	public sealed class DesignationManager : IExposable
	{
		...
		{
			DesignationManager.<AllDesignationsOn>c__Iterator1CF <AllDesignationsOn>c__Iterator1CF = new DesignationManager.<AllDesignationsOn>c__Iterator1CF();
			<AllDesignationsOn>c__Iterator1CF.t = t;
			<AllDesignationsOn>c__Iterator1CF.<$>t = t;
			<AllDesignationsOn>c__Iterator1CF.<>f__this = this;
			DesignationManager.<AllDesignationsOn>c__Iterator1CF expr_1C = <AllDesignationsOn>c__Iterator1CF;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			DesignationManager.<AllDesignationsAt>c__Iterator1D0 <AllDesignationsAt>c__Iterator1D = new DesignationManager.<AllDesignationsAt>c__Iterator1D0();
			<AllDesignationsAt>c__Iterator1D.c = c;
			<AllDesignationsAt>c__Iterator1D.<$>c = c;
			<AllDesignationsAt>c__Iterator1D.<>f__this = this;
			DesignationManager.<AllDesignationsAt>c__Iterator1D0 expr_1C = <AllDesignationsAt>c__Iterator1D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			DesignationManager.<DesignationsOfDef>c__Iterator1D1 <DesignationsOfDef>c__Iterator1D = new DesignationManager.<DesignationsOfDef>c__Iterator1D1();
			<DesignationsOfDef>c__Iterator1D.def = def;
			<DesignationsOfDef>c__Iterator1D.<$>def = def;
			<DesignationsOfDef>c__Iterator1D.<>f__this = this;
			DesignationManager.<DesignationsOfDef>c__Iterator1D1 expr_1C = <DesignationsOfDef>c__Iterator1D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
