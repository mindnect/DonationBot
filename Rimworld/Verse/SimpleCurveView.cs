...
namespace Verse
{
	public class SimpleCurveView
	{
		...
		public IEnumerable<float> DebugInputValues
		{
			get
			{
				SimpleCurveView.<>c__Iterator20C <>c__Iterator20C = new SimpleCurveView.<>c__Iterator20C();
				<>c__Iterator20C.<>f__this = this;
				SimpleCurveView.<>c__Iterator20C expr_0E = <>c__Iterator20C;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
