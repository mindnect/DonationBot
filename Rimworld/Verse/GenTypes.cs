...
namespace Verse
{
	public static class GenTypes
	{
		...
		public static IEnumerable<Type> AllTypes
		{
			get
			{
				GenTypes.<>c__Iterator220 <>c__Iterator = new GenTypes.<>c__Iterator220();
				GenTypes.<>c__Iterator220 expr_07 = <>c__Iterator;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
		...
		{
			GenTypes.<InstantiableDescendantsAndSelf>c__Iterator221 <InstantiableDescendantsAndSelf>c__Iterator = new GenTypes.<InstantiableDescendantsAndSelf>c__Iterator221();
			<InstantiableDescendantsAndSelf>c__Iterator.baseType = baseType;
			<InstantiableDescendantsAndSelf>c__Iterator.<$>baseType = baseType;
			GenTypes.<InstantiableDescendantsAndSelf>c__Iterator221 expr_15 = <InstantiableDescendantsAndSelf>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
