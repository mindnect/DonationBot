...
namespace Verse
{
	public class SoundDef : Def
	{
		...
		{
			SoundDef.<ConfigErrors>c__Iterator1BA <ConfigErrors>c__Iterator1BA = new SoundDef.<ConfigErrors>c__Iterator1BA();
			<ConfigErrors>c__Iterator1BA.<>f__this = this;
			SoundDef.<ConfigErrors>c__Iterator1BA expr_0E = <ConfigErrors>c__Iterator1BA;
			expr_0E.$PC = -2;
			return expr_0E;
		}
