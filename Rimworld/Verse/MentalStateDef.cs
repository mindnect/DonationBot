...
namespace Verse
{
	public class MentalStateDef : Def
	{
		...
		{
			MentalStateDef.<ConfigErrors>c__Iterator1AF <ConfigErrors>c__Iterator1AF = new MentalStateDef.<ConfigErrors>c__Iterator1AF();
			<ConfigErrors>c__Iterator1AF.<>f__this = this;
			MentalStateDef.<ConfigErrors>c__Iterator1AF expr_0E = <ConfigErrors>c__Iterator1AF;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
