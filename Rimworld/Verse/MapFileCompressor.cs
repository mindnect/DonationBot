...
namespace Verse
{
	public class MapFileCompressor : IExposable
	{
		...
		{
			MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CE <ThingsToSpawnAfterLoad>c__Iterator1CE = new MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CE();
			<ThingsToSpawnAfterLoad>c__Iterator1CE.<>f__this = this;
			MapFileCompressor.<ThingsToSpawnAfterLoad>c__Iterator1CE expr_0E = <ThingsToSpawnAfterLoad>c__Iterator1CE;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
