...
namespace Verse
{
	public class ThingWithComps : Thing
	{
		...
		{
			ThingWithComps.<GetComps>c__Iterator124<T> <GetComps>c__Iterator = new ThingWithComps.<GetComps>c__Iterator124<T>();
			<GetComps>c__Iterator.<>f__this = this;
			ThingWithComps.<GetComps>c__Iterator124<T> expr_0E = <GetComps>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			ThingWithComps.<GetGizmos>c__Iterator125 <GetGizmos>c__Iterator = new ThingWithComps.<GetGizmos>c__Iterator125();
			<GetGizmos>c__Iterator.<>f__this = this;
			ThingWithComps.<GetGizmos>c__Iterator125 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			ThingWithComps.<GetFloatMenuOptions>c__Iterator126 <GetFloatMenuOptions>c__Iterator = new ThingWithComps.<GetFloatMenuOptions>c__Iterator126();
			<GetFloatMenuOptions>c__Iterator.selPawn = selPawn;
			<GetFloatMenuOptions>c__Iterator.<$>selPawn = selPawn;
			<GetFloatMenuOptions>c__Iterator.<>f__this = this;
			ThingWithComps.<GetFloatMenuOptions>c__Iterator126 expr_1C = <GetFloatMenuOptions>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
