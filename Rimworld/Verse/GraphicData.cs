...
namespace Verse
{
	public class GraphicData
	{
		...
		{
			GraphicData.<ConfigErrors>c__Iterator1A4 <ConfigErrors>c__Iterator1A = new GraphicData.<ConfigErrors>c__Iterator1A4();
			<ConfigErrors>c__Iterator1A.thingDef = thingDef;
			<ConfigErrors>c__Iterator1A.<$>thingDef = thingDef;
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			GraphicData.<ConfigErrors>c__Iterator1A4 expr_1C = <ConfigErrors>c__Iterator1A;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
