...
namespace Verse.AI
{
	public static class Toils_JobTransforms
	{
		...
		{
			Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19B <IngredientPlaceCellsInOrder>c__Iterator19B = new Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19B();
			<IngredientPlaceCellsInOrder>c__Iterator19B.billGiver = billGiver;
			<IngredientPlaceCellsInOrder>c__Iterator19B.<$>billGiver = billGiver;
			Toils_JobTransforms.<IngredientPlaceCellsInOrder>c__Iterator19B expr_15 = <IngredientPlaceCellsInOrder>c__Iterator19B;
			expr_15.$PC = -2;
			return expr_15;
		}
