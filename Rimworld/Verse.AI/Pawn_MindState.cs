...
namespace Verse.AI
{
	public class Pawn_MindState : IExposable
	{
		...
		{
			Pawn_MindState.<GetGizmos>c__Iterator19D <GetGizmos>c__Iterator19D = new Pawn_MindState.<GetGizmos>c__Iterator19D();
			<GetGizmos>c__Iterator19D.<>f__this = this;
			Pawn_MindState.<GetGizmos>c__Iterator19D expr_0E = <GetGizmos>c__Iterator19D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
