...
namespace Verse.AI
{
	public class JobDriver_HaulToCell : JobDriver
	{
		...
		{
			JobDriver_HaulToCell.<MakeNewToils>c__Iterator199 <MakeNewToils>c__Iterator = new JobDriver_HaulToCell.<MakeNewToils>c__Iterator199();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_HaulToCell.<MakeNewToils>c__Iterator199 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
