...
namespace Verse.AI
{
	public class JobDriver_Wait : JobDriver
	{
		...
		{
			JobDriver_Wait.<MakeNewToils>c__Iterator193 <MakeNewToils>c__Iterator = new JobDriver_Wait.<MakeNewToils>c__Iterator193();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_Wait.<MakeNewToils>c__Iterator193 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
