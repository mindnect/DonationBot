...
namespace Verse.Sound
{
	public class SubSoundDef : Editable
	{
		...
		{
			SubSoundDef.<ConfigErrors>c__Iterator1BB <ConfigErrors>c__Iterator1BB = new SubSoundDef.<ConfigErrors>c__Iterator1BB();
			<ConfigErrors>c__Iterator1BB.<>f__this = this;
			SubSoundDef.<ConfigErrors>c__Iterator1BB expr_0E = <ConfigErrors>c__Iterator1BB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
