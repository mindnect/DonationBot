...
namespace RimWorld.Planet
{
	public class WorldObjectsHolder : IExposable
	{
		...
		{
			WorldObjectsHolder.<ObjectsAt>c__IteratorF6 <ObjectsAt>c__IteratorF = new WorldObjectsHolder.<ObjectsAt>c__IteratorF6();
			<ObjectsAt>c__IteratorF.tileID = tileID;
			<ObjectsAt>c__IteratorF.<$>tileID = tileID;
			<ObjectsAt>c__IteratorF.<>f__this = this;
			WorldObjectsHolder.<ObjectsAt>c__IteratorF6 expr_1C = <ObjectsAt>c__IteratorF;
			expr_1C.$PC = -2;
			return expr_1C;
		}
