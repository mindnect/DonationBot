...
namespace RimWorld.Planet
{
	...
	public class FactionBase : MapParent, ITrader
	{
		...
		{
			FactionBase.<GetGizmos>c__IteratorF2 <GetGizmos>c__IteratorF = new FactionBase.<GetGizmos>c__IteratorF2();
			<GetGizmos>c__IteratorF.<>f__this = this;
			FactionBase.<GetGizmos>c__IteratorF2 expr_0E = <GetGizmos>c__IteratorF;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			FactionBase.<GetFloatMenuOptions>c__IteratorF3 <GetFloatMenuOptions>c__IteratorF = new FactionBase.<GetFloatMenuOptions>c__IteratorF3();
			<GetFloatMenuOptions>c__IteratorF.caravan = caravan;
			<GetFloatMenuOptions>c__IteratorF.<$>caravan = caravan;
			<GetFloatMenuOptions>c__IteratorF.<>f__this = this;
			FactionBase.<GetFloatMenuOptions>c__IteratorF3 expr_1C = <GetFloatMenuOptions>c__IteratorF;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
