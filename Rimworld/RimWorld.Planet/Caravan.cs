...
namespace RimWorld.Planet
{
	...
	public class Caravan : WorldObject, IIncidentTarget, ITrader, ILoadReferenceable
	{
		...
		{
			Caravan.<GetGizmos>c__IteratorEC <GetGizmos>c__IteratorEC = new Caravan.<GetGizmos>c__IteratorEC();
			<GetGizmos>c__IteratorEC.<>f__this = this;
			Caravan.<GetGizmos>c__IteratorEC expr_0E = <GetGizmos>c__IteratorEC;
			expr_0E.$PC = -2;
			return expr_0E;
		}
