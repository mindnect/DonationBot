...
namespace RimWorld.Planet
{
	public class WorldSelector
	{
		...
		{
			WorldSelector.<SelectableObjectsAt>c__Iterator185 <SelectableObjectsAt>c__Iterator = new WorldSelector.<SelectableObjectsAt>c__Iterator185();
			<SelectableObjectsAt>c__Iterator.tileID = tileID;
			<SelectableObjectsAt>c__Iterator.<$>tileID = tileID;
			WorldSelector.<SelectableObjectsAt>c__Iterator185 expr_15 = <SelectableObjectsAt>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
