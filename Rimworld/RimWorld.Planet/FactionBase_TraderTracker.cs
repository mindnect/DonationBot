...
namespace RimWorld.Planet
{
	public class FactionBase_TraderTracker : IExposable
	{
		...
		{
			FactionBase_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorF4 <ColonyThingsWillingToBuy>c__IteratorF = new FactionBase_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorF4();
			<ColonyThingsWillingToBuy>c__IteratorF.playerNegotiator = playerNegotiator;
			<ColonyThingsWillingToBuy>c__IteratorF.<$>playerNegotiator = playerNegotiator;
			FactionBase_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorF4 expr_15 = <ColonyThingsWillingToBuy>c__IteratorF;
			expr_15.$PC = -2;
			return expr_15;
		}
