...
namespace RimWorld.Planet
{
	public class Caravan_TraderTracker : IExposable
	{
		...
		public IEnumerable<Thing> Goods
		{
			get
			{
				Caravan_TraderTracker.<>c__IteratorED <>c__IteratorED = new Caravan_TraderTracker.<>c__IteratorED();
				<>c__IteratorED.<>f__this = this;
				Caravan_TraderTracker.<>c__IteratorED expr_0E = <>c__IteratorED;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Caravan_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorEE <ColonyThingsWillingToBuy>c__IteratorEE = new Caravan_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorEE();
			<ColonyThingsWillingToBuy>c__IteratorEE.playerNegotiator = playerNegotiator;
			<ColonyThingsWillingToBuy>c__IteratorEE.<$>playerNegotiator = playerNegotiator;
			Caravan_TraderTracker.<ColonyThingsWillingToBuy>c__IteratorEE expr_15 = <ColonyThingsWillingToBuy>c__IteratorEE;
			expr_15.$PC = -2;
			return expr_15;
		}
