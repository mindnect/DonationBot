...
namespace RimWorld.Planet
{
	...
	public class WorldObject : ILoadReferenceable, IExposable, ISelectable
	{
		...
		{
			WorldObject.<GetGizmos>c__IteratorEA <GetGizmos>c__IteratorEA = new WorldObject.<GetGizmos>c__IteratorEA();
			WorldObject.<GetGizmos>c__IteratorEA expr_07 = <GetGizmos>c__IteratorEA;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			WorldObject.<GetFloatMenuOptions>c__IteratorEB <GetFloatMenuOptions>c__IteratorEB = new WorldObject.<GetFloatMenuOptions>c__IteratorEB();
			WorldObject.<GetFloatMenuOptions>c__IteratorEB expr_07 = <GetFloatMenuOptions>c__IteratorEB;
			expr_07.$PC = -2;
			return expr_07;
		}
